...
"stroke-width","fill"],["#8b94ac","2","none"]),o=this.T$("text",["text-anchor","stroke","fill"],["end","none","#8b94ac"]),a="y"==this.N.layout?"50%":this.z$-10,u="y"==this.N.layout?11:17,c=this.T$("tspan",["x","y","class"],[a,u,"webix_bullet_header"]),f=this.T$("tspan",["x","y","class"],[a,u+17,"webix_bullet_subheader"]),l=this.T$("text",["text-anchor","stroke","class","fill"],["middle","none","webix_bullet_scale","#8b94ac"]),d=this.F$(["filter",["id","x","y","width","height"],[t,"0","-150%","110%","400%"],[["feOffset",["in","dx","dy"],["SourceAlpha",0,0]],["feGaussianBlur",["stdDeviation"],["2"]],["feComponentTransfer",0,0,[["feFuncA",["type","slope"],["linear","0.5"]]]],["feMerge",0,0,[["feMergeNode"],["feMergeNode",["in"],["SourceGraphic"]]]]]]);i.appendChild(d);var v=document.createElement("div");e.appendChild(s),!1!==this.N.marker&&(r.setAttribute("x",this.z$+this.xg(this.N.marker)*this.I$-2),e.appendChild(r)),e.appendChild(n),o.appendChild(c),o.appendChild(f),i.appendChild(o);var _="y"===this.N.layout,p=this.N.tickSize;if(this.N.scale){for(var b=this.z$,m=this.N.minRange;m<=this.N.maxRange;m+=this.N.scale.step){var g=Math.max(m-this.N.minRange,0),w=Math.floor(g*this.I$-(g?.1:-1)),x=_?(this.$width-this.N.barWidth)/2+(p?2-p:4):w+b,y=_?this.H$+b-w+6:this.N.barWidth+(p?16+p:14),M=_?-4:this.N.barWidth+3+p,S=_?"end":"middle",k=this.T$("tspan",["x","y","text-anchor"],[x,y,S]),C=this.T$("line",["x1","y1","x2","y2","stroke-width"],[w+b,M,w+b,M-p,1]);v.innerHTML=this.N.scale.template({value:m}),k.appendChild(v.childNodes[0]),l.appendChild(k),h.appendChild(C)}e.appendChild(h),i.appendChild(l)}for(var $=0;$<this.N.bands.length;$++){var D=this.N.bands[$],I=this.T$("path"),A=this.xg(D.value)*this.I$;I.setAttribute("d","M "+this.z$+",0 l "+A+",0 l 0,"+this.N.barWidth+" l -"+A+",0 z"),I.setAttribute("fill",D.color),s.appendChild(I)}if(i.appendChild(e),"y"===this.N.layout){var T=this.N.scale?this.$width/2-10:0,F=this.$height+this.z$-28;e.setAttribute("transform","translate("+T+", "+F+") rotate(270)"),o.setAttribute("text-anchor","middle"),o.childNodes[0].setAttribute("x","55%"),o.childNodes[1].setAttribute("x","55%"),l.setAttribute("text-anchor","right")}return i.setAttribute("viewBox","0 0 "+this.$width+" "+this.$height),i},a$:function(t){this.config.minRange,this.config.maxRange,t=t||("x"==this.N.layout?this.$width:this.$height);var i=this.$view;i.innerHTML="";var e=this.N,s=e.label&&e.label(e)||e.placeholder&&e.placeholder(e);this.z$=s?e.labelHeight||e.labelWidth:7,this.B$=Math.floor((this.N.barWidth-this.N.stroke)/2),this.H$=t-this.z$-30,this.I$=this.H$/(this.N.maxRange-this.N.minRange);var n=this.V$();n.setAttribute("height",this.$height),n.setAttribute("width",this.$width),i.appendChild(n),this.D$=i.querySelector(".webix_bullet_value");var r=this.N.label;r&&(this.$view.querySelector(".webix_bullet_header").textContent=r(this.N));var h=this.N.placeholder;h&&(this.$view.querySelector(".webix_bullet_subheader").textContent=h(this.N))},refresh:function(){this.a$(),this._$(this.d$,this.N.value)},setValue:function(t){this.N.value!=t&&this._$(this.N.value,t)},getValue:function(){return this.N.value}},Jh=(F.protoUI(Kh,Gi.view),{name:"geochart",defaults:{chart:{displayMode:"auto",region:"world",resolution:"countries"}},$init:function(t){this.$view.innerHTML="<div class='webix_map_content' style='width:100%;height:100%'></div>",this.qi=this.$view.firstChild,this.R$=b.defer(),t.chart=F.extend(t.chart||{},this.defaults.chart),this.data.provideApi(this,!0),this.$ready.push(this.render),this.data.attachEvent("onClearAll",k(this.E$,this)),this.data.attachEvent("onStoreUpdated",k(this.P$,this))},getMap:function(t){return t?this.R$:this.wu},j$:function(t){return k(function(){"function"==typeof t&&t(),qh=qh||window.google,this.N$()},this)},render:function(){"undefined"==typeof window.google||"undefined"==typeof window.google.charts?(Yh||((Yh=document.createElement("script")).type="text/javascript",Yh.src="//www.gstatic.com/charts/loader.js",document.getElementsByTagName("head")[0].appendChild(Yh)),Yh.onload=this.j$(Yh.onload)):this.j$()()},
N$:function(){qh.visualization&&qh.visualization.GeoChart?(this.wu=new qh.visualization.GeoChart(this.qi),this.L$(),this.R$.resolve(this.wu)):(qh.charts.load("current",{packages:["geochart"],mapsApiKey:this.N.key}),qh.charts.setOnLoadCallback(k(function(){this.N$()},this)))},$onLoad:function(t){return!this.wu&&(this.R$.then(k(function(){this.parse(t,this.N.datatype)},this)),!0)},P$:function(){if(this.wu){var n=this.ll&&this.ll.length?this.ll:this.O$(),r=[];if(this.data.each(function(t){for(var i=[],e=0;e<n.length;e++){var s=t[n[e].label];"number"==n[e].type?s*=1:"tooltip"==n[e].role&&(s=this.N.tooltip(t)),i.push(s)}r.push(i)},this),n.length){for(var t=new qh.visualization.DataTable,i=0;i<n.length;i++)t.addColumn(n[i]);t.addRows(r);var e=new qh.visualization.DataView(t);this.wu.draw(e,this.N.chart)}else this.wu.draw(qh.visualization.arrayToDataTable([["",""]]),{})}else this.wu||this.R$.then(k(this.P$,this))},setDisplayMode:function(t){this.N.chart.displayMode=t,this.refresh()},setRegion:function(t){this.N.chart.region=t,this.refresh()},refresh:function(){this.wu.clearChart(),this.P$()},tooltip_setter:function(t){var i=this.N.chart.tooltip;return this.N.chart.tooltip=F.extend(i||{},{isHtml:!0}),Lt(t)},$setSize:function(t,i){Gi.api.$setSize.apply(this,arguments)&&this.wu&&(F.extend(this.N,{width:t,height:i}),this.refresh())},E$:function(){this.ll=null,this.P$()},W$:function(t,i){if(!t||V(t[i]))return"string";var e=M(t[i]);return"string"!=e||isNaN(1*t[i])||(e="number"),e},O$:function(){var t=this.N.columns||[],i=this.data.pull[this.data.order[0]];if(!t.length&&i)for(var e in i)"id"!==e&&t.push(e);for(var s=0;s<t.length;s++)"object"!==M(t[s])&&(t[s]={type:this.W$(i,t[s]),label:t[s]});return this.N.tooltip&&t.push({type:"string",role:"tooltip",p:{html:!0}}),this.ll=t},L$:function(){qh.visualization.events.addListener(this.wu,"error",k(function(){this.callEvent("onMapError",arguments)},this)),qh.visualization.events.addListener(this.wu,"ready",k(function(){this.callEvent("onMapReady",arguments)},this)),qh.visualization.events.addListener(this.wu,"regionClick",k(function(){this.callEvent("onRegionClick",arguments)},this)),qh.visualization.events.addListener(this.wu,"select",k(function(){var t=this.wu.getSelection()[0];t&&this.callEvent("onItemClick",[this.data.order[t.row]])},this))}}),Zh=(F.protoUI(Jh,ke,v,Gi.view),{name:"google-map",$init:function(){this.$view.innerHTML="<div class='webix_map_content' style='width:100%;height:100%'></div>",this.qi=this.$view.firstChild,this.R$=b.defer(),this.data.provideApi(this,!0),this.$ready.push(this.render)},getMap:function(t){return t?this.R$:this.wu},j$:function(t){return k(function(){"function"==typeof t&&t(),Gh=Gh||window.google,this.N$.call(this)},this)},render:function(){if("undefined"==typeof window.google||"undefined"==typeof window.google.maps){if(!Xh){(Xh=document.createElement("script")).type="text/javascript";var t=this.N,i=t.src||"//maps.google.com/maps/api/js";i+=-1===i.indexOf("?")?"?":"&",t.key&&(i+="&key="+t.key),t.libraries&&(i+="&libraries="+t.libraries),Xh.src=i,document.getElementsByTagName("head")[0].appendChild(Xh)}Xh.onload=this.j$(Xh.onload)}else this.j$()()},N$:function(){var t=this.config;this.isVisible(t.id)&&(this.wu=new Gh.maps.Map(this.qi,{zoom:t.zoom,center:new Gh.maps.LatLng(t.center[0],t.center[1]),mapTypeId:Gh.maps.MapTypeId[t.mapType]}),this.R$.resolve(this.wu),this.qi.firstChild.setAttribute("webix_disable_drag","true"))},center_setter:function(t){return this.wu&&this.wu.setCenter(new Gh.maps.LatLng(t[0],t[1])),t},mapType_setter:function(t){return this.wu&&this.wu.setMapTypeId(Gh.maps.MapTypeId[t]),t},zoom_setter:function(t){return this.wu&&this.wu.setZoom(t),t},layerType_setter:function(t){return"heatmap"==t&&(this.config.libraries="visualization"),this.U$[t]&&(F.extend(this,this.U$[t],!0),this.data.attachEvent("onStoreUpdated",k(function(){this.R$.then(k(function(){this.drawData.call(this,arguments)},this))},this))),t},defaults:{zoom:5,center:[39.5,-98.5],mapType:"ROADMAP",layerType:"marker"},$setSize:function(){Gi.api.$setSize.apply(this,arguments),
this.wu&&Gh.maps.event.trigger(this.wu,"resize")},$onLoad:function(t){return!this.wu&&(this.R$.then(k(function(){this.parse(t)},this)),!0)},U$:{marker:{drawData:function(t,i,e){switch(e){case"add":case"update":i.$marker=this.q$(i);break;case"delete":i.$marker.setMap(null);break;default:this.data.each(function(t){t.$marker=this.q$(t)},this)}},clearAll:function(t){this.data.each(function(t){t.$marker.setMap(null)}),this.data.clearAll(t)},showItem:function(t){var i=this.getItem(t);this.wu.setCenter(new Gh.maps.LatLng(i.lat,i.lng))},q$:function(t){var i={};for(var e in t)i[e]=t[e];i.position=new Gh.maps.LatLng(t.lat,t.lng),i.map=t.hidden?null:this.wu;var s=t.$marker;return s?t.$marker.setMap(i.map):(s=new Gh.maps.Marker(i),this.Mt(s)),this.callEvent("onItemRender",[t]),s},Mt:function(t){var i=this;t.addListener("click",function(){i.callEvent("onItemClick",[this.id,this])}),t.getDraggable()&&(t.addListener("dragend",function(){i.Y$(this,!0)}),t.addListener("drag",function(){i.Y$(this)}))},Y$:function(t,i){var e=this.getItem(t.id),s=t.getPosition(),n=i?"onAfterDrop":"onDrag";e.lat=s.lat(),e.lng=s.lng(),this.callEvent(n,[e.id,e])}},heatmap:{heatmapConfig_setter:function(t){return t=t||{}},drawData:function(){this.G$&&(this.G$.setMap(null),this.G$=null);var i=[];if(this.data.each(function(t){i.push(this.X$(t))},this),i.length){var t=F.extend(this.config.heatmapConfig,{data:i,map:this.wu},!0);this.G$=new Gh.maps.visualization.HeatmapLayer(t),this.callEvent("onHeatMapRender",[this.G$])}},getHeatmap:function(){return this.G$},X$:function(t){var i={};for(var e in t)i[e]=t[e];return i.location=new Gh.maps.LatLng(t.lat,t.lng),i}}}}),Qh=(F.protoUI(Zh,ke,v,Gi.view),{$render_pie:function(t,i,e,s,n,r){this.K$(t,i,e,s,1,r,n)},K$:function(t,i,e,s,n,r,h){if(i.length){var o=this.J$(e,s),a=this.N.radius?this.N.radius:o.radius;if(!(a<0)){var u=this.Z$(i),c=this.nf(u),f=this.sf(u,c),l=this.N.x?this.N.x:o.x,d=this.N.y?this.N.y:o.y;1==n&&this.N.shadow&&this.Q$(t,l,d,a),d/=n;var v,_=-Math.PI/2,p=[];if(t.scale(1,n),this.N.gradient){var b=1!=n?l+a/3:l,m=1!=n?d+a/3:d;this.tD(t,l,d,a,b,m)}for(var g=0;g<i.length;g++)if(u[g]){t.strokeStyle=this.N.lineColor.call(this,i[g]),t.beginPath(),t.moveTo(l,d),p.push(_);var w=-Math.PI/2+f[g]-1e-4;t.arc(l,d,a,_,w,!1),t.lineTo(l,d);var x=this.N.color.call(this,i[g]);t.fillStyle=x,t.fill(),this.N.pieInnerText&&this.iD(l,d,5*a/6,_,w,n,this.N.pieInnerText(i[g],c),!0),this.N.label&&this.iD(l,d,a+this.N.labelOffset,_,w,n,this.N.label(i[g])),1!=n&&(this.eD(t,l,d,_,w,a,!0),t.fillStyle="#000000",t.globalAlpha=.2,this.eD(t,l,d,_,w,a,!1),t.globalAlpha=1,t.fillStyle=x),r.addSector(i[g].id,_,w,l-e.x,d-e.y/n,a,n,h),_=w}for(t.globalAlpha=.8,g=0;g<p.length;g++)v=this.hf(p[g],l,d,a),this.sD(t,l,d,v.x,v.y,this.N.lineColor.call(this,i[g]),2);(t.globalAlpha=1)==n&&this.N.border&&(t.lineWidth=this.N.borderWidth||2,t.strokeStyle=this.N.borderColor?this.N.borderColor.call(this):"#ffffff",t.beginPath(),t.arc(l,d,a+1,0,2*Math.PI,!1),t.stroke()),t.scale(1,1/n)}}},Z$:function(t){for(var i=[],e=0;e<t.length;e++)i.push(Math.abs(parseFloat(this.N.value(t[e]))||0));return i},nf:function(t){for(var i=0,e=0;e<t.length;e++)i+=t[e];return i},sf:function(t,i){var e,s=[],n=0;i=i||this.nf(t);for(var r=0;r<t.length;r++)e=t[r],s[r]=2*Math.PI*(i?(e+n)/i:1/t.length),n+=e;return s},J$:function(t,i){var e=i.x-t.x,s=i.y-t.y;return{x:t.x+e/2,y:t.y+s/2,radius:Math.min(e/2,s/2)}},eD:function(t,i,e,s,n,r,h){if(t.lineWidth=1,s<=0&&0<=n||0<=s&&n<=Math.PI||.003<Math.abs(s-Math.PI)&&s<=Math.PI&&n>=Math.PI){s<=0&&0<=n&&(s=0,h=!1,this.nD(t,i,e,r,s,n)),s<=Math.PI&&n>=Math.PI&&(n=Math.PI,h=!1,this.nD(t,i,e,r,s,n));var o=(this.N.pieHeight||Math.floor(r/4))/this.N.cant;t.beginPath(),t.arc(i,e,r,s,n,!1),t.lineTo(i+r*Math.cos(n),e+r*Math.sin(n)+o),t.arc(i,e+o,r,n,s,!0),t.lineTo(i+r*Math.cos(s),e+r*Math.sin(s)),t.fill(),h&&t.stroke()}},nD:function(t,i,e,s,n,r){t.beginPath(),t.arc(i,e,s,n,r,!1),t.stroke()},Q$:function(t,i,e,s){t.globalAlpha=.5;for(var n=["#c4c4c4","#c6c6c6","#cacaca","#dcdcdc","#dddddd","#e0e0e0","#eeeeee","#f5f5f5","#f8f8f8"],r=n.length-1;-1<r;r--)t.beginPath(
),t.fillStyle=n[r],t.arc(i+1,e+1,s+r,0,2*Math.PI,!0),t.fill();t.globalAlpha=1},rD:function(t){return t.addColorStop(0,"#ffffff"),t.addColorStop(.7,"#7a7a7a"),t.addColorStop(1,"#000000"),t},tD:function(t,i,e,s,n,r){var h;t.beginPath(),h="function"!=typeof this.N.gradient?(h=t.createRadialGradient(n,r,s/4,i,e,s),this.rD(h)):this.N.gradient(h),t.fillStyle=h,t.arc(i,e,s,0,2*Math.PI,!0),t.fill(),t.globalAlpha=.7},iD:function(t,i,e,s,n,r,h,o){var a=this.canvases[0].renderText(0,0,h,0,1);if(a){var u=a.scrollWidth;a.style.width=u+"px",t<u&&(u=t);var c=n-s<.2?4:8;o&&(c=u/1.8);var f=s+(n-s)/2;e-=(c-8)/2;var l=-c,d="right";(f>=Math.PI/2&&f<Math.PI||f<=3*Math.PI/2&&f>=Math.PI)&&(l=-u-l+1,d="left");var v=0;!o&&r<1&&0<f&&f<Math.PI&&(v=(this.N.height||Math.floor(e/4))/r);var _=(i+Math.floor((e+v)*Math.sin(f)))*r-8,p=t+Math.floor((e+c/2)*Math.cos(f))+l,b=n<Math.PI/2+.01,m=s<Math.PI/2;m&&b?p=Math.max(p,t+3):m||b?!o&&(f>=Math.PI/2&&f<Math.PI||f<=3*Math.PI/2&&f>=Math.PI)&&(p+=u/3):p=Math.min(p,t-u),a.style.top=_+"px",a.style.left=p+"px",a.style.width=u+"px",a.style.textAlign=d,a.style.whiteSpace="nowrap"}},$render_pie3D:function(t,i,e,s,n,r){this.K$(t,i,e,s,this.N.cant,r)},$render_donut:function(t,i,e,s,n,r){if(i.length){this.K$(t,i,e,s,1,r,n);var h=this.N,o=this.J$(e,s),a=h.radius?h.radius:o.radius;if(!(a<=0)){var u=h.innerRadius&&h.innerRadius<a?h.innerRadius:a/3,c=h.x?h.x:o.x,f=h.y?h.y:o.y;if(t.fillStyle=te.backColor,t.beginPath(),t.arc(c,f,u,0,2*Math.PI,!0),t.fill(),this.N.donutInnerText){var l=this.Z$(i),d=this.nf(l),v=te.dataPadding,_=2*u-2*v,p=this.canvases[0].renderText(c-u+v,f-u+v,'<div class="webix_donut_center_text">'.concat(this.N.donutInnerText(i,d),"</div>"),"webix_donut_center_text_box",_);p.style.height=p.style.lineHeight=_+"px"}}}}}),to={$render_bar:function(t,i,e,s,n,r){var h,o,a,u,c,f,l,d,v,_,p,b,m,g=s.y-e.y;m=!!this.N.yAxis,b=!!this.N.xAxis,c=(u=this.hD()).max,f=u.min,o=(s.x-e.x)/i.length,n||"auto"!=this.N.origin&&!m||this.oD(i,e,s,f,c,o),m&&(c=parseFloat(this.N.yAxis.end),f=parseFloat(this.N.yAxis.start)),l=(v=this.aD(f,c))[0],d=v[1],p=l?g/l:l,m||"auto"!=this.N.origin&&b||(_=10,p=l?(g-_)/l:_),!n&&"auto"!=this.N.origin&&!m&&this.N.origin>f&&this.uD(t,i,e,s,o,s.y-p*(this.N.origin-f)),h=parseInt(this.N.barWidth,10);var w=0,x=0;for(a=0;a<this.cD.length;a++)a==n&&(x=w),"bar"==this.cD[a].type&&w++;this.cD&&o<h*w+4&&(h=parseInt(o/w-4,10));var y=(o-h*w)/2,M="undefined"!=typeof this.N.radius?parseInt(this.N.radius,10):Math.round(h/5),S=!1,k=this.N.gradient;for(k&&"function"!=typeof k?(S=k,k=!1):k&&(k=t.createLinearGradient(0,s.y,0,e.y),this.N.gradient(k)),b||this.sD(t,e.x,s.y+.5,s.x,s.y+.5,"#edeff0",1),a=0;a<i.length;a++){var C=parseFloat(this.N.value(i[a])||0);if(this.fD&&(C=this.lD(C)),C&&!isNaN(C)){c<C&&(C=c),C-=f,C*=d;var $=e.x+y+a*o+(h+1)*x,D=s.y,I=k||this.N.color.call(this,i[a]),A=this.N.border?1:0,T=this.N.label(i[a]);m||"auto"!=this.N.origin&&b?C==this.N.origin||"auto"==this.N.origin&&this.N.value(i[a])==f?(A=0,T=""):(C<0||this.N.yAxis&&0===C&&!("auto"!=this.N.origin&&this.N.origin>f))&&(C=A=0,T=""):C+=_/p,t.globalAlpha=this.N.alpha.call(this,i[a]);var F=this.g$(t,e,$,D,h,f,M,p,C,I,k,S,A);S&&this.dD(t,$,D,h,f,M,p,C,I,S,A),A&&this.vD(t,$,D,h,f,M,p,C,I),t.globalAlpha=1,F[0]!=$?this.canvases[n].renderTextAt(!1,!0,$+Math.floor(h/2),F[1],T):this.canvases[n].renderTextAt(!0,!0,$+Math.floor(h/2),F[3],T),r.addRect(i[a].id,[$-e.x,F[3]-e.y,F[2]-e.x,F[1]-e.y],n)}}},_D:function(t,i,e,s,n,r,h){var o=e;return"auto"!=this.N.origin&&this.N.origin>h&&(o=e-=(this.N.origin-h)*n,(s-=this.N.origin-h)<0&&(s*=-1,t.translate(i+r,e),t.rotate(Math.PI),e=i=0),e-=.5),{value:s,x0:i,y0:e,start:o}},g$:function(t,i,e,s,n,r,h,o,a,u,c,f,l){t.save(),t.fillStyle=u;var d=this._D(t,e,s,a,o,n,r),v=this.pD(t,d.x0,d.y0,n,h,o,d.value,l);c&&!f&&t.lineTo(d.x0+l,i.y),t.fill(),t.restore();var _=d.x0,p=d.x0!=e?e+v[0]:v[0];return[_,d.x0!=e?d.start-v[1]-d.y0:d.y0,p,d.x0!=e?d.start-d.y0:v[1]]},bD:function(t,i){var e,s;s=Ze.toRgb(i),(e=Ze.rgbToHsv(s[0],s[1],s[2]))[2]/=1.4;var n="rgb("+Ze.hsvToRgb(e[0],e[1],e[2])+")";t.strokeStyle=n,1==t.globalAlpha&&(t.globalAlpha=.9)},
vD:function(t,i,e,s,n,r,h,o,a){var u;t.save(),u=this._D(t,i,e,o,h,s,n),this.bD(t,a),this.pD(t,u.x0,u.y0,s,r,h,u.value,t.lineWidth/2,1),t.stroke(),t.restore()},dD:function(t,i,e,s,n,r,h,o,a,u,c){t.save();var f=this._D(t,i,e,o,h,s,n),l=this.mD(t,f.x0,f.y0,f.x0+s,f.y0-h*f.value+2,u,a,"y");t.fillStyle=l.gradient,this.pD(t,f.x0+l.offset,f.y0,s-2*l.offset,r,h,f.value,l.offset+c),t.fill(),t.restore()},pD:function(t,i,e,s,n,r,h,o,a){t.beginPath();var u=0;if(r*h<n){var c=(n-r*h)/n;c<=1&&-1<=c&&(u=-Math.acos(c)+Math.PI/2)}t.moveTo(i+o,e);var f=e-Math.floor(r*h)+n+(n?0:o);n<r*h&&t.lineTo(i+o,f);var l=i+n;n&&0<n&&t.arc(l,f,Math.max(n-o,0),-Math.PI+u,-Math.PI/2,!1);var d=i+s-n-o,v=f-n+(n?o:0);t.lineTo(d,v),n&&0<n&&t.arc(d+o,f,Math.max(n-o,0),-Math.PI/2,0-u,!1);var _=i+s-o;return t.lineTo(_,e),a||t.lineTo(i+o,e),[_,v]}},io={$render_line:function(t,i,e,s,n,r){var h,o,a,u,c,f,l,d,v,_,p,b;if(u=this.gD(t,i,e,s,n),h=this.N,i.length){for(c=h.offset?e.x+.5*u.cellWidth:e.x,a=[],o=0;o<i.length;o++)if((b=this.wD(i[o],e,s,u))||"0"==b){if(l=o?u.cellWidth*o-.5+c:c,v="object"==M(b)?b.y0:b,o&&this.N.fixOverflow){if((p=this.wD(i[o-1],e,s,u)).out&&p.out==b.out)continue;f=u.cellWidth*(o-1)-.5+c,d="object"==M(p)?p.y0:p,p.out&&(_="min"==p.out?s.y:e.y,a.push({x:this.xD(f,l,d,v,_),y:_})),b.out&&(_="min"==b.out?s.y:e.y,a.push({x:this.xD(f,l,d,v,_),y:_}))}b.out||a.push({x:l,y:b,index:o})}for(this.yD=e,o=1;o<=a.length;o++)f=a[o-1].x,d=a[o-1].y,o<a.length&&(l=a[o].x,v=a[o].y,this.sD(t,f,d,l,v,h.line.color.call(this,i[o-1]),h.line.width),h.line&&h.line.shadow&&(t.globalAlpha=.3,this.sD(t,f+2,d+h.line.width+8,l+2,v+h.line.width+8,"#eeeeee",h.line.width+3),t.globalAlpha=1)),"undefined"!=typeof a[o-1].index&&this.MD(t,f,d,i[a[o-1].index],h.label(i[a[o-1].index]),n,r,e)}},xD:function(t,i,e,s,n){return t+(n-e)*(i-t)/(s-e)},MD:function(t,i,e,s,n,r,h){var o=this.N.item,a=parseInt(o.radius.call(this,s),10)||0,u=this.yD,c=o.type.call(this,s);if(a){if(t.save(),o.shadow){t.lineWidth=1,t.strokeStyle="#bdbdbd",t.fillStyle="#bdbdbd";for(var f=[.1,.2,.3],l=f.length-1;0<=l;l--)t.globalAlpha=f[l],t.strokeStyle="#d0d0d0",t.beginPath(),this.SD(t,i,e+2*a/3,a+l+1,c),t.stroke();t.beginPath(),t.globalAlpha=.3,t.fillStyle="#bdbdbd",this.SD(t,i,e+2*a/3,a+1,c),t.fill()}t.restore(),t.lineWidth=o.borderWidth,t.fillStyle=o.color.call(this,s),t.strokeStyle=o.borderColor.call(this,s),t.globalAlpha=o.alpha.call(this,s),t.beginPath(),this.SD(t,i,e,a+1,c),t.fill(),t.stroke(),t.globalAlpha=1}if(n&&this.canvases[r].renderTextAt(!1,!0,i,e-a-this.N.labelOffset,this.N.label.call(this,s)),h){var d=this.N.eventRadius||a+1;h.addRect(s.id,[i-d-u.x,e-d-u.y,i+d-u.x,e+d-u.y],r)}},SD:function(t,i,e,s,n){var r=[];if(!n||"square"!=n&&"s"!=n)if(!n||"diamond"!=n&&"d"!=n)r=!n||"triangle"!=n&&"t"!=n?[[i,e,s,0,2*Math.PI,!0]]:[[i,e-s],[i+Math.sqrt(3)*s/2,e+s/2],[i-Math.sqrt(3)*s/2,e+s/2],[i,e-s]];else{var h=1<t.lineWidth?t.lineWidth*Math.sqrt(2)/4:0;r=[[i,e-s],[i+s,e],[i,e+s],[i-s,e],[i+h,e-s-h]]}else r=[[i-(s*=Math.sqrt(2)/2)-t.lineWidth/2,e-s],[i+s,e-s],[i+s,e+s],[i-s,e+s],[i-s,e-s]];this.kD(t,r)},wD:function(t,i,e,s){var n=s.minValue,r=s.maxValue,h=s.unit,o=s.valueFactor,a=this.N.value(t);this.fD&&(a=this.lD(a));var u=(parseFloat(a||0)-n)*o;this.N.yAxis||(u+=s.startValue/h);var c=e.y-h*u;return!this.N.fixOverflow||"line"!=this.N.type&&"area"!=this.N.type?(r<a&&(c=i.y),(u<0||a<n)&&(c=e.y)):r<a?c={y:i.y,y0:c,out:"max"}:(u<0||a<n)&&(c={y:e.y,y0:c,out:"min"}),c},gD:function(t,i,e,s,n){var r,h={};h.totalHeight=s.y-e.y,this.N.cellWidth?h.cellWidth=Math.min(s.x-e.x,this.N.cellWidth):h.cellWidth=(s.x-e.x)/(this.N.offset?i.length:i.length-1);var o=!!this.N.yAxis,a=-1!=this.N.type.indexOf("stacked")?this.CD(i):this.hD();h.maxValue=a.max,h.minValue=a.min,n||this.oD(i,e,s,h.minValue,h.maxValue,h.cellWidth),o&&(h.maxValue=parseFloat(this.N.yAxis.end),h.minValue=parseFloat(this.N.yAxis.start));var u=this.aD(h.minValue,h.maxValue);return r=u[0],h.valueFactor=u[1],h.unit=r?h.totalHeight/r:10,h.startValue=0,o||(h.startValue=10,h.unit!=h.totalHeight&&(h.unit=r?(h.totalHeight-h.startValue)/r:10)),h}},eo={$render_barH:function(t,i,
e,s,n,r){var h,o,a,u,c,f,l,d,v,_,p,b,m,g,w,x,y,M,S,k,C;for(a=(s.y-e.y)/i.length,d=(l=this.hD("h")).max,v=l.min,x=s.x-e.x,C=!!this.N.xAxis,n||this.$D(t,i,e,s,v,d,a),C&&(d=parseFloat(this.N.xAxis.end),v=parseFloat(this.N.xAxis.start)),b=(g=this.aD(v,d))[0],p=g[1],M=b?x/b:10,C||(w=10,M=b?(x-w)/b:10),(o=parseInt(this.N.barWidth,10))*this.cD.length+4>a&&(o=a/this.cD.length-4),h=Math.floor((a-o*this.cD.length)/2),m="undefined"!=typeof this.N.radius?parseInt(this.N.radius,10):Math.round(o/5),_=!1,(c=this.N.gradient)&&"function"!=typeof c?(_=c,c=!1):c&&(c=t.createLinearGradient(e.x,e.y,s.x,e.y),this.N.gradient(c)),C||this.sD(t,e.x-.5,e.y,e.x-.5,s.y,"#edeff0",1),f=0;f<i.length;f++)if(y=parseFloat(this.N.value(i[f]||0)),this.fD&&(y=this.lD(y)),y&&!isNaN(y))if(d<y&&(y=d),y-=v,y*=p,S=e.x,k=e.y+h+f*a+(o+1)*n,y<0&&"auto"==this.N.origin||this.N.xAxis&&0===y&&!("auto"!=this.N.origin&&this.N.origin>v))this.canvases[n].renderTextAt("middle","right",S+10,k+o/2+h,this.N.label(i[f]));else{y<0&&"auto"!=this.N.origin&&this.N.origin>v&&(y=0),C||(y+=w/M),u=c||this.N.color.call(this,i[f]),this.N.border&&this.DD(t,S,k,o,v,m,M,y,u),t.globalAlpha=this.N.alpha.call(this,i[f]);var $=this.ID(t,s,S,k,o,v,m,M,y,u,c,_);_&&this.AD(t,S,k,o,v,m,M,y,u,_),t.globalAlpha=1,$[3]==k?(this.canvases[n].renderTextAt("middle","left",$[0]-5,$[3]+Math.floor(o/2),this.N.label(i[f])),r.addRect(i[f].id,[$[0]-e.x,$[3]-e.y,$[2]-e.x,$[3]+o-e.y],n)):(this.canvases[n].renderTextAt("middle",!1,$[2]+5,$[1]+Math.floor(o/2),this.N.label(i[f])),r.addRect(i[f].id,[$[0]-e.x,k-e.y,$[2]-e.x,$[3]-e.y],n))}},TD:function(t,i,e,s,n,r,h,o,a){var u=0;if(r*h<n){var c=(n-r*h)/n;u=-Math.asin(c)+Math.PI/2}t.moveTo(i,e+o);var f=i+r*h-n-(n?0:o);f=Math.max(i,f),n<r*h&&t.lineTo(f,e+o);var l=e+n;n&&0<n&&t.arc(f,l,n-o,-Math.PI/2+u,0,!1);var d=e+s-n-(n?0:o),v=f+n-(n?o:0);t.lineTo(v,d),n&&0<n&&t.arc(f,d,n-o,0,Math.PI/2-u,!1);var _=e+s-o;return t.lineTo(i,_),a||t.lineTo(i,e+o),[v,_]},$D:function(t,i,e,s,n,r,h){var o=0;this.N.xAxis&&(this.canvases.x||(this.canvases.x=this.FD("axis_x")),o=this.VD(this.canvases.x.getCanvas(),i,e,s,n,r)),this.N.yAxis&&(this.canvases.y||(this.canvases.y=this.FD("axis_y")),this.zD(this.canvases.y.getCanvas(),i,e,s,h,o))},zD:function(t,i,e,s,n,r){if(this.N.yAxis){var h,o=parseInt(r||e.x,10)-.5,a=s.y+.5,u=e.y;this.sD(t,o,a,o,u,this.N.yAxis.color,1);for(var c=0;c<i.length;c++){var f="auto"!=this.N.origin&&"barH"==this.N.type&&parseFloat(this.N.value(i[c]))<this.N.origin;h=u+n/2+c*n,this.canvases.y.renderTextAt("middle",!f&&"left",f?o+5:o-5,h,this.N.yAxis.template(i[c]),"webix_axis_item_y",f?0:o-10),this.N.yAxis.lines.call(this,i[c])&&this.sD(t,e.x,h,s.x,h,this.N.yAxis.lineColor.call(this,i[c]),1)}this.N.yAxis.lines.call(this,{})&&this.sD(t,e.x+.5,u+.5,s.x,u+.5,this.N.yAxis.lineColor.call(this,{}),1),this.BD(e,s)}},VD:function(t,i,e,s,n,r){var h,o={},a=this.N.xAxis;if(a){var u=s.y+.5,c=e.x-.5,f=s.x-.5,l=e.x;if(this.sD(t,c,u,f,u,a.color,1),a.step&&(h=parseFloat(a.step)),"undefined"!=typeof this.HD.step&&"undefined"!=typeof this.HD.start&&"undefined"!=typeof this.HD.end||(n=(o=this.RD(n,r)).start,r=o.end,h=o.step,this.N.xAxis.end=r,this.N.xAxis.start=n,this.N.xAxis.step=h),0!==h){for(var d=(f-c)*h/(r-n),v=0,_=n;_<=r;_+=h){var p=this.fD?Math.pow(10,_):_;o.fixNum&&(p=parseFloat(p).toFixed(o.fixNum));var b=Math.floor(c+v*d)+.5;if(_==n&&"auto"==this.N.origin||!a.lines.call(this,_)||this.sD(t,b,u,b,e.y,this.N.xAxis.lineColor.call(this,_),1),_==this.N.origin&&(l=b+1),h<1&&!this.fD){var m=Math.min(Math.floor(this.lD(h)),n<=0?0:Math.floor(this.lD(n))),g=Math.pow(10,-m);_=p=Math.round(p*g)/g}this.canvases.x.renderTextAt(!1,!0,b,u+2,a.template(p.toString()),"webix_axis_item_x"),v++}return this.canvases.x.renderTextAt(!0,!1,c,s.y+this.N.padding.bottom-3,this.N.xAxis.title,"webix_axis_title_x",s.x-e.x),l}}},ED:function(t,i,e,s,n,r,h){var o=i;return this.N.yAxis&&"auto"!=this.N.origin&&this.N.origin>h&&(o=i+=(this.N.origin-h)*n,(s-=this.N.origin-h)<0&&(s*=-1,t.translate(i,e+r),t.rotate(Math.PI),i=.5,e=0),i+=.5),{value:s,x0:i,y0:e,start:o}},ID:function(t,i,e,s,n,r,h,o,a,u,c,f){t.save()
;var l=this.ED(t,e,s,a,o,n,r);t.fillStyle=u,t.beginPath();var d=this.TD(t,l.x0,l.y0,n,h,o,l.value,this.N.border?1:0);c&&!f&&t.lineTo(i.x,l.y0+(this.N.border?1:0)),t.fill(),t.restore();var v=l.y0,_=l.y0!=s?s:d[1];return[l.y0!=s?l.start-d[0]:l.start,v,l.y0!=s?l.start:d[0],_]},DD:function(t,i,e,s,n,r,h,o,a){t.save();var u=this.ED(t,i,e,o,h,s,n);t.beginPath(),this.bD(t,a),t.globalAlpha=.9,this.TD(t,u.x0,u.y0,s,r,h,u.value,t.lineWidth/2,1),t.stroke(),t.restore()},AD:function(t,i,e,s,n,r,h,o,a,u){t.save();var c=this.ED(t,i,e,o,h,s,n),f=this.mD(t,c.x0,c.y0+s,c.x0+h*c.value,c.y0,u,a,"x");t.fillStyle=f.gradient,t.beginPath(),this.TD(t,c.x0,c.y0+f.offset,s-2*f.offset,r,h,c.value,f.offset),t.fill(),t.globalAlpha=1,t.restore()}},so={$render_stackedBar:function(t,i,e,s,n,r){var h,o,a,u,c,f,l,d=this.N,v=s.y-e.y,_=!!d.yAxis,p=!!d.xAxis,b=this.CD(i),m=0===d.origin;h=b.max,o=b.min;var g=Math.floor((s.x-e.x)/i.length);n||(a=this.oD(i,e,s,o,h,g)),_&&(h=parseFloat(d.yAxis.end),o=parseFloat(d.yAxis.start));var w=this.aD(o,h);l=w[0],f=w[1];var x=l?v/l:10,y=parseInt(d.barWidth,10);g<y+4&&(y=g-4);var M=Math.floor((g-y)/2),S=!!d.gradient&&d.gradient;p||this.sD(t,e.x,s.y+.5,s.x,s.y+.5,"#edeff0",1);for(var k=0;k<i.length;k++){var C=parseFloat(d.value(i[k]||0));this.fD&&(C=this.lD(C)),u=e.x+M+k*g;var $=m&&C<0;if(n?c=$?i[k].$startYN:i[k].$startY:(c=a-1,i[k].$startY=c,m&&($&&(c=a+1),i[k].$startYN=a+1)),C&&!isNaN(C)){n||m||(C-=o),C*=f;var D=d.border,I=d.label(i[k]);if(!(c<e.y+1)){var A=this.N.color.call(this,i[k]),T=Math.abs(c-(m?s.y+o*x:s.y))<3;t.globalAlpha=d.alpha.call(this,i[k]),t.fillStyle=t.strokeStyle=d.color.call(this,i[k]),t.beginPath();var F=c-x*C+(T?$?-1:1:0);Math.floor(F)>s.y&&(F=s.y,""!=I&&F-c<pt('<div class="webix_canvas_text">'.concat(I,"</div>"),this.$view.className).height&&(I=""));var V=this.PD(t,u-(D?.5:0),c,y+(D?.5:0),F,0,e.y);if(t.fill(),t.stroke(),S){t.save();var z=this.mD(t,u,c,u+y,V[1],S,A,"y");t.fillStyle=z.gradient,t.beginPath(),V=this.PD(t,u+z.offset,c,y-2*z.offset,F,D?1:0,e.y),t.fill(),t.restore()}D&&(t.save(),"string"==typeof D?t.strokeStyle=D:this.bD(t,A),t.beginPath(),this.PD(t,u-.5,parseInt(c,10)+.5,y+1,parseInt(F,10)+.5,0,e.y,T),t.stroke(),t.restore()),t.globalAlpha=1,this.canvases[n].renderTextAt(!1,!0,u+Math.floor(y/2),V[1]+(c-V[1])/2-7,I),r.addRect(i[k].id,[u-e.x,V[1]-e.y,V[0]-e.x,i[k][$?"$startYN":"$startY"]-e.y],n),i[k][$?"$startYN":"$startY"]=V[1]}}}},PD:function(t,i,e,s,n,r,h,o){t.moveTo(i,e),n<h&&(n=h),t.lineTo(i,n);var a=i+s,u=n;t.lineTo(a,u);var c=i+s;return t.lineTo(c,e),o||t.lineTo(i,e),[c,u]}},no={$render_stackedBarH:function(t,i,e,s,n,r){var h,o,a,u,c=s.x-e.x,f=!!this.N.yAxis,l=this.CD(i);h=l.max,o=l.min;var d=Math.floor((s.y-e.y)/i.length);n||this.$D(t,i,e,s,o,h,d),f&&(h=parseFloat(this.N.xAxis.end),o=parseFloat(this.N.xAxis.start));var v=this.aD(o,h);u=v[0],a=v[1];var _=u?c/u:10,p=0;f||(p=10,_=u?(c-p)/u:10);var b=parseInt(this.N.barWidth,10);d<b+4&&(b=d-4);var m=(d-b)/2,g=!1,w=this.N.gradient;w&&(g=!0),f||this.sD(t,e.x-.5,e.y,e.x-.5,s.y,"#edeff0",1);var x=0,y=0;for(M=0;M<this.cD.length;M++)M==n&&(y=x),"stackedBarH"==this.cD[M].type&&x++;for(var M=0;M<i.length;M++){y||(i[M].$startX=e.x);var S=Math.abs(parseFloat(this.N.value(i[M]||0)));h<S&&(S=h),S-=o,S*=a;var k=e.x,C=e.y+m+M*d;if(y?k=i[M].$startX:i[M].$startX=k,S&&!isNaN(S)){f||(S+=p/_);var $=this.N.color.call(this,i[M]);t.globalAlpha=this.N.alpha.call(this,i[M]),t.fillStyle=this.N.color.call(this,i[M]),t.beginPath();var D=this.TD(t,k,C,b,0,_,S,0);if(w&&!g&&t.lineTo(e.x+c,C+(this.N.border?1:0)),t.fill(),g){var I=this.mD(t,k,C+b,k,C,g,$,"x");t.fillStyle=I.gradient,t.beginPath(),D=this.TD(t,k,C,b,0,_,S,0),t.fill()}this.N.border&&this.DD(t,k,C,b,o,0,_,S,$),t.globalAlpha=1,this.canvases[n].renderTextAt("middle",!0,i[M].$startX+(D[0]-i[M].$startX)/2-1,C+(D[1]-C)/2,this.N.label(i[M])),r.addRect(i[M].id,[i[M].$startX-e.x,C-e.y,D[0]-e.x,D[1]-e.y],n),i[M].$startX=D[0]}}}},ro={$render_area:function(t,i,e,s,n,r){var h,o,a,u,c,f,l,d,v,_,p,b,m,g,w;if(f=this.gD(t,i,e,s,n),u=(o=this.N).eventRadius||Math.floor(f.cellWidth/2),i.length){for(l=[],
_=o.offset?e.x+.5*f.cellWidth:e.x,a=0;a<i.length;a++)if(c=i[a],v=this.wD(c,e,s,f),m=_+f.cellWidth*a,v){if(g="object"==M(v)?v.y0:v,a&&this.N.fixOverflow){if((d=this.wD(i[a-1],e,s,f)).out&&d.out==v.out)continue;p=f.cellWidth*(a-1)-.5+_,b="object"==M(d)?d.y0:d,d.out&&(w="min"==d.out?s.y:e.y,l.push([this.xD(p,m,b,g,w),w])),v.out&&(w="min"==v.out?s.y:e.y,l.push([this.xD(p,m,b,g,w),w]),a==i.length-1&&w==e.y&&l.push([m,e.y]))}v.out||(l.push([m,g]),r.addRect(c.id,[m-u-e.x,g-u-e.y,m+u-e.x,g+u-e.y],n)),o.yAxis||(h=o.offset||a!=i.length-1?"center":"left",this.canvases[n].renderTextAt(!1,h,m,g-o.labelOffset,o.label(c)))}l.length&&(l.push([m,s.y]),l.push([l[0][0],s.y])),t.globalAlpha=this.N.alpha.call(this,i[0]),t.fillStyle=this.N.color.call(this,i[0]),t.beginPath(),this.kD(t,l),t.fill(),t.lineWidth=1,t.globalAlpha=1,o.border&&(t.lineWidth=o.borderWidth||1,o.borderColor?t.strokeStyle=o.borderColor.call(this,i[0]):this.bD(t,t.fillStyle),t.beginPath(),this.kD(t,l),t.stroke())}},$render_stackedArea:function(t,e,i,s,n,r){var h,o,a,u,c,f,l,d,v,_,p,b,m,g,w,x,y;if(v=this.gD(t,e,i,s,n),l=(u=this.N).eventRadius||Math.floor(v.cellWidth/2),e.length){_=[],m=[],p=u.offset?i.x+.5*v.cellWidth:i.x;var M=function(t,i){return n?e[t].$startY?i-s.y+e[t].$startY:0:i};for(c=0;c<e.length;c++)d=e[c],c?p+=v.cellWidth:(b=M(c,s.y),_.push([p,b])),b=M(c,this.wD(d,i,s,v)),m.push(isNaN(b)&&!c?e[c].$startY||s.y:b),b&&(_.push([p,b]),r.addRect(d.id,[p-l-i.x,b-l-i.y,p+l-i.x,b+l-i.y],n),u.yAxis||(u.offset,a="center",this.canvases[n].renderTextAt(!1,a,p,b-u.labelOffset,u.label(d))));if(_.push([p,M(c-1,s.y)]),n)for(c=e.length-2;0<c;c--)p-=v.cellWidth,(b=e[c].$startY)&&_.push([p,b]);for(_.push([_[0][0],_[0][1]]),t.globalAlpha=this.N.alpha.call(this,e[0]),t.fillStyle=this.N.color.call(this,e[0]),t.beginPath(),this.kD(t,_),t.fill(),c=0;c<e.length;c++){if(!(b=m[c]))for(c==e.length-1&&(b=e[c].$startY),f=c+1;f<e.length;f++)if(m[f]){h={x:i.x,y:m[0]},o={x:i.x+v.cellWidth*f,y:m[f]},g=i.x+v.cellWidth*c,void 0,b=(y=((x=o).y-(w=h).y)/(x.x-w.x))*g+w.y-y*w.x;break}e[c].$startY=b}}}},ho={$render_radar:function(t,i,e,s,n,r){this.jD(t,i,e,s,n,r)},jD:function(t,i,e,s,n,r){if(i.length){for(var h=this.J$(e,s),o=this.N.radius?this.N.radius:h.radius,a=this.N.x?this.N.x:h.x,u=this.N.y?this.N.y:h.y,c=[],f=0;f<i.length;f++)c.push(1);var l=this.sf(c,i.length);this.yD=e,n||this.ND(l,a,u,o,i),this.LD(t,l,a,u,o,i,n,r)}},LD:function(t,i,e,s,n,r,h,o){var a,u,c,f,l,d,v,_,p,b,m,g,w,x,y,M,S,k,C;for(l=(c=this.N).yAxis.start,d=c.yAxis.end,k=(g=(C=this.aD(l,d))[0])?n/g:n/2,S=C[1],a=u=w=-Math.PI/2,p=[],f=_=0;f<r.length;f++)y=M||(x=c.value(r[f]),this.fD&&(x=this.lD(x)),(parseFloat(x||0)-l)*S),b=Math.floor(k*y),x=c.value(f!=r.length-1?r[f+1]:r[0]),this.fD&&(x=this.lD(x)),M=(parseFloat(x||0)-l)*S,m=Math.floor(k*M),a=u,u=f!=r.length-1?w+i[f]-1e-4:w,v=_||this.hf(a,e,s,b),_=this.hf(u,e,s,m),p.push(v);c.fill&&this.OD(t,p,r),!c.disableLines&&2<r.length&&this.WD(t,p,r),(!c.disableItems||r.length<3)&&this.UD(t,p,r,h,o),p=null},UD:function(t,i,e,s,n){for(var r=0;r<i.length;r++)this.MD(t,i[r].x,i[r].y,e[r],this.N.label.call(this,e),s,n)},OD:function(t,i,e){var s,n;t.globalAlpha=this.N.alpha.call(this,{}),t.beginPath();for(var r=0;r<i.length;r++)t.fillStyle=this.N.fill.call(this,e[r]),s=i[r],n=i[r+1]||i[0],r||t.moveTo(s.x,s.y),t.lineTo(n.x,n.y);t.fill(),t.globalAlpha=1},WD:function(t,i,e){for(var s,n,r=0;r<i.length;r++)s=i[r],n=i[r+1]||i[0],this.sD(t,s.x,s.y,n.x,n.y,this.N.line.color.call(this,e[r]),this.N.line.width)},ND:function(t,i,e,s,n){var r=this.N.yAxis,h=this.N.xAxis,o=r.start,a=r.end,u=r.step,c={},f=this.qD;if("undefined"==typeof f.step||"undefined"==typeof f.start||"undefined"==typeof f.end){var l=this.hD();o=(c=this.RD(l.min,l.max)).start,a=c.end,u=c.step,r.end=a,r.start=o}var d,v,_,p,b,m=[],g=0,w=s*u/(a-o);u<1&&(p=Math.min(this.lD(u),o<=0?0:this.lD(o)),b=Math.pow(10,-p));var x=[];this.canvases.scale||(this.canvases.scale=this.FD("radar_scale"));var y=this.canvases.scale.getCanvas();for(d=a;o<=d;d-=u){var M=this.fD?Math.pow(10,d):d;c.fixNum&&(M=parseFloat(d).toFixed(c.fixNum)),m.push(Math.floor(g*w)+.5),
b&&!this.fD&&(d=M=Math.round(M*b)/b);var S=e-s+m[m.length-1];this.canvases.scale.renderTextAt("middle","left",i,S,r.template(M.toString()),"webix_axis_item_y webix_radar");var k,C=-Math.PI/2,$=C;for(v=0;v<t.length;v++)g||x.push($),k=C+t[v]-1e-4,this.YD(y,2<t.length?f.lineShape||"line":"arc",i,e,s-m[m.length-1],$,k,d,v,n[d]),$=k;g++}for(d=0;d<x.length;d++)_=this.hf(x[d],i,e,s),h&&(h.lines.call(this,n[d],d)&&this.sD(y,i,e,_.x,_.y,h.lineColor.call(this,n[d]),1),this.GD(y,i,e,s,x[d],h.template.call(this,n[d])))},YD:function(t,i,e,s,n,r,h,o,a){var u,c;if(n<0)return!1;u=this.hf(r,e,s,n),c=this.hf(h,e,s,n);var f=this.N.yAxis;f.bg&&(t.beginPath(),t.moveTo(e,s),"arc"==i?t.arc(e,s,n,r,h,!1):(t.lineTo(u.x,u.y),t.lineTo(c.x,c.y)),t.fillStyle=f.bg(o,a),t.moveTo(e,s),t.fill(),t.closePath()),f.lines.call(this,o)&&(t.lineWidth=1,t.beginPath(),"arc"==i?t.arc(e,s,n,r,h,!1):(t.moveTo(u.x,u.y),t.lineTo(c.x,c.y)),t.strokeStyle=f.lineColor.call(this,o),t.stroke())},GD:function(t,i,e,s,n,r){if(!r)return!1;var h=this.canvases.scale.renderText(0,0,r,"webix_axis_radar_title",1),o=h.scrollWidth,a=h.offsetHeight,u=this.hf(n,i,e,s+5),c=0,f=0;(n<0||n>Math.PI)&&(f=-a),n>Math.PI/2&&(c=-o),Math.abs(n+Math.PI/2)<.001||Math.abs(n-Math.PI/2)<.001?c=-o/2:(Math.abs(n)<.001||Math.abs(n-Math.PI)<.001)&&(f=-a/2),h.style.top=u.y+f+"px",h.style.left=u.x+c+"px",h.style.width=o+"px",h.style.whiteSpace="nowrap"}},oo={$render_scatter:function(t,i,e,s,n,r){if(this.N.xValue){var h=this.N,o=!(h.disableLines||"undefined"==typeof h.disableLines),a=this.hD(),u=this.hD("h","xValue");n||(this.canvases.x||(this.canvases.x=this.FD("axis_x")),this.canvases.y||(this.canvases.y=this.FD("axis_y")),this.XD(this.canvases.y.getCanvas(),i,e,s,a.min,a.max),this.VD(this.canvases.x.getCanvas(),i,e,s,u.min,u.max)),a={min:h.yAxis.start,max:h.yAxis.end},u={min:h.xAxis.start,max:h.xAxis.end};var c=this.KD(t,i,e,s,u,a);this.yD=e;for(var f,l,d,v,_,p=[],b=0;b<i.length;b++){var m=this.JD(c,s,e,u,i[b],"X"),g=this.JD(c,e,s,a,i[b],"Y");isNaN(m)||isNaN(g)||p.push({x:m,y:g,index:b})}for(var w=0;w<p.length;w++){if(_=p[w].index,o){var x=h.line.color.call(this,i[_]);f=p[w].x,l=p[w].y,w==p.length-1?h.shape&&2<p.length&&(this.sD(t,d,v,p[0].x,p[0].y,x,h.line.width),h.disableItems||this.ZD(t,r,p[0],i[0],n),h.fill&&this.QD(t,p,i)):(d=p[w+1].x,v=p[w+1].y,this.sD(t,f,l,d,v,x,h.line.width))}!h.disableItems&&p[w]&&this.ZD(t,r,p[w],i[_],n)}}},QD:function(t,i,e){var s,n;t.globalAlpha=this.N.alpha.call(this,{}),t.beginPath();for(var r=0;r<i.length;r++)t.fillStyle=this.N.fill.call(this,e[r]),s=i[r],n=i[r+1]||i[0],r||t.moveTo(s.x,s.y),t.lineTo(n.x,n.y);t.fill(),t.globalAlpha=1},KD:function(t,i,e,s,n,r){var h={};return h.totalHeight=s.y-e.y,h.totalWidth=s.x-e.x,this.tI(h,n.min,n.max,h.totalWidth,"X"),this.tI(h,r.min,r.max,h.totalHeight,"Y"),h},ZD:function(t,i,e,s,n){this.MD(t,e.x,e.y,s,this.N.label.call(this,s),n,i)},JD:function(t,i,e,s,n,r){var h=this.N["X"==r?"xValue":"value"].call(this,n),o=t["valueFactor"+r],a=(parseFloat(h||0)-s.min)*o,u=t["unit"+r],c=e[r.toLowerCase()]-("X"==r?-1:1)*Math.floor(u*a);return a<0&&(c=e[r.toLowerCase()]),h>s.max&&(c=i[r.toLowerCase()]),h<s.min&&(c=e[r.toLowerCase()]),c},tI:function(t,i,e,s,n){var r=this.aD(i,e);t["relValue"+(n=n||"")]=r[0],t["valueFactor"+n]=r[1],t["unit"+n]=t["relValue"+n]?s/t["relValue"+n]:10}},ao={$render_splineArea:function(t,i,e,s,n,r){var h,o,a,u,c,f,l,d,v,_,p,b,m,g=this.N,w=[];if(f=this.gD(t,i,e,s,n),c=g.eventRadius||Math.floor(f.cellWidth/2),a=[],i.length){for(v=g.offset?e.x+.5*f.cellWidth:e.x,o=0;o<i.length;o++)((b=this.wD(i[o],e,s,f))||"0"==b)&&(d=o?f.cellWidth*o-.5+v:v,a.push({x:d,y:b,index:o}),r.addRect(i[o].id,[d-c-e.x,b-c-e.y,d+c-e.x,b+c-e.y],n));for(l=this.iI(a),o=0;o<a.length;o++)if(_=a[o].x,o<a.length-1){for(p=a[o+1].x,m=a[o+1].y,u=_;u<p;u++){var x=this.eI(u,_,o,l.a,l.b,l.c,l.d);x<e.y&&(x=e.y),x>s.y&&(x=s.y);var y=this.eI(u+1,_,o,l.a,l.b,l.c,l.d);y<e.y&&(y=e.y),y>s.y&&(y=s.y),w.push([u,x]),w.push([u+1,y])}w.push([p,m])}h=this.N.color.call(this,i[0]),w.length&&(w.push([p,s.y]),w.push([w[0][0],s.y])),t.globalAlpha=this.N.alpha.call(this,i[0]),
t.fillStyle=h,t.beginPath(),this.kD(t,w),t.fill(),t.lineWidth=1,t.globalAlpha=1,g.border&&(t.lineWidth=g.borderWidth||1,g.borderColor?t.strokeStyle=g.borderColor.call(this,i[0]):this.bD(t,h),t.beginPath(),w.splice(w.length-3),this.kD(t,w),t.stroke())}}},uo={dynamic_setter:function(t){return t&&function i(h){if(h.sI)return;var o=h.N;o.cellWidth||(o.cellWidth=30);o.animateDuration||(o.animateDuration=400);o.offset=!1,h.sI=h.attachEvent("onBeforeRender",function(t,i){var e=h.nI(h.xe,h.Me);!function s(e){fo(e,function(t,i){i.Ne(e.xe+2*e.N.cellWidth,e.Me)})}(h),function r(t,i,e,s){if(s&&t.length){var n=Math.ceil((e.x-i.x)/s);t.length>n+1&&t.splice(0,t.length-n-1)}}(t,e.start,e.end,o.cellWidth),"add"==i&&function n(i){var t=i.N.cellWidth;i.rI!=t&&(i.rI=t,i.render());i.rI=0,i.hI=null,window.requestAnimationFrame&&!document.hidden&&window.requestAnimationFrame(function(t){!function r(i,t){var e,s=i.N.animateDuration,n=i.N.cellWidth;n&&1<i.count()&&(i.hI||(i.hI=t),e=t-i.hI,i.rI=Math.min(Math.max(e/s*n,1),n),i.render(),e<s&&window.requestAnimationFrame(function(t){r(i,t)}))}(i,t)});i.oI||(i.oI=i.attachEvent("onAfterRender",function(t){!function r(t,c){var f=t.count(),e=t.nI(t.xe,t.Me),l=t.N.cellWidth,d=t.rI||0,i=c.length<f||(c.length-1)*l>e.end.x-e.start.x;function s(t,i,e,s){var n=t.getCanvas(),r=t.Pe,h=t.Be,o=t.He;if(d&&(c.length<f||(c.length-1)*l>e-i)?(r.style.left=-d+"px",1<c.length&&(!function u(t,i,e){if(t.length){rt(t[0]);for(var s=1;s<t.length;s++)co(e,t[s])||(t[s].style.left=t[s].offsetLeft-i+"px")}}(h,d,o),n.clearRect(0,0,i+d,r.offsetHeight),n.clearRect(e+d,0,r.offsetWidth,r.offsetHeight))):(r.style.left="0px",s||d==l||n.clearRect(i+(c.length-1)*l-l+d,0,r.offsetWidth,r.offsetHeight)),1<h.length&&d&&d!=l){var a=h.length-1;co(o,h[a])&&(a-=1),h[a].style.display="none"}}fo(t,function(t,i){s(i,e.start.x,e.end.x,"x"==t)}),function n(t,i,e){t.qi.Oi.style.left=i.start.x-e+"px",t.qi.Oi.style.width=i.end.x-i.start.x+e+"px"}(t,e,i?d:0)}(i,t)}))}(h)}),h.aI=h.attachEvent("onBeforeXAxis",function(t,i,e,s,n,r){return function _(t,i,e,s,n,r,h){var o,a,u,c,f=t.N,l=s.x-.5,d=parseInt(h||n.y,10)+.5,v=n.x;if(!f.dynamic)return!1;for(u=(e.length-1)*r>v-l||e.length<t.count(),a=0;a<e.length;a++)c=l+a*r,o=u?1<a:!!a,c=Math.ceil(c)-.5,t.uI(c,d,e[a],o),a&&f.xAxis.lines.call(t,e[a])&&t.cI(i,c,n.y,s.y,e[a]);t.canvases.x.renderTextAt(!0,!1,l,n.y+f.padding.bottom-3,f.xAxis.title,"webix_axis_title_x",n.x-s.x),t.sD(i,l,d,v+(u?t.rI:0),d,f.xAxis.color,1)}(h,t,i,e,s,n,r),!1})}(this),t}};function co(t,i){return"axis_x"===t&&-1!==i.className.indexOf("webix_axis_title_x")}function fo(t,i){if(t.canvases){for(var e=0;e<t.cD.length;e++)t.canvases[e]&&i(e,t.canvases[e]);t.canvases.x&&i("x",t.canvases.x)}}var lo={name:"chart",$init:function(t){if(this.cD=[this.N],this.fI=[],this.qi.className+=" webix_chart",this.$ready.push(this.vh),t.preset&&this.lI(t),t.series){var i=t.series;delete t.series,t.series=i}this.data.provideApi(this,!0)},vh:function(){this.data.attachEvent("onStoreUpdated",k(function(){this.render.apply(this,arguments)},this))},defaults:{ariaLabel:"chart",color:"default",alpha:"1",radius:0,label:!1,value:"{obj.value}",padding:{},type:"pie",lineColor:"#ffffff",cant:.5,barWidth:30,line:{width:2,color:"#1ca1c1"},item:{radius:3,borderColor:"#1ca1c1",borderWidth:2,color:"#ffffff",alpha:1,type:"r",shadow:!1},shadow:!1,gradient:!1,border:!1,labelOffset:20,origin:"auto",scale:"linear"},_id:"webix_area_id",on_click:{webix_chart_legend_item:function(t,i,e){var s=e.getAttribute("series_id");if(this.callEvent("onLegendClick",[t,s,e])&&void 0!==s&&1<this.cD.length){var n=this.N,r=n.legend.values;(r&&r[s].toggle||n.legend.toggle)&&(-1!=e.className.indexOf("hidden")?this.showSeries(s):this.hideSeries(s))}}},on_dblclick:{},on_mouse_move:{},locate:function(t){return ot(t,this._id)},$setSize:function(t,i){var e=Gi.api.$setSize.call(this,t,i);if(e){for(var s in this.canvases)this.canvases[s].Ne(this.xe,this.Me);this.render()}return e},type_setter:function(t){return this["$render_"+t],"undefined"==typeof this.N.offset&&(this.N.offset=!(-1!=t.toLowerCase().indexOf("area"))
),"radar"!=t||this.N.yAxis||this.define("yAxis",{}),"scatter"==t&&(this.N.yAxis||this.define("yAxis",{}),this.N.xAxis||this.define("xAxis",{})),t},destructor:function(){this.removeAllSeries(),Ri.destructor.apply(this,arguments)},removeAllSeries:function(){this.clearCanvas(),this.dI&&(this.dI.innerHTML="",this.dI.parentNode.removeChild(this.dI),this.dI=null),this.canvases&&(this.canvases={}),this.qi.innerHTML="",this.cD=[]},clearCanvas:function(){if(this.canvases&&"object"==M(this.canvases))for(var t in this.canvases)this.canvases[t].clearCanvas()},render:function(t,i,e){var s,n,r,h;if(this.isVisible(this.N.id)&&(n=this.vI(),this.callEvent("onBeforeRender",[n,e]))){if(this.canvases&&"object"==M(this.canvases))for(var o in this.canvases)this.canvases[o].clearCanvas();else this.canvases={};if(this.N.legend&&(this.canvases.legend||(this.canvases.legend=this.FD("legend")),this._I(this.data.getRange(),this.xe,this.Me)),this.wu=r=new je(this._id),h=this.N,s=this.nI(this.xe,this.Me),this.cD)for(var a=0;a<this.cD.length;a++)this.N=this.cD[a],this.canvases[a]||(this.canvases[a]=this.FD(this.name+" "+a,"z-index:"+(2+a),null,a,this.N.ariaLabel)),this["$render_"+this.N.type](this.canvases[a].getCanvas(),n,s.start,s.end,a,r);if(r.render(this.qi),this.qi.lastChild.style.zIndex=80,this.pI(this.qi.lastChild,s),this.callEvent("onAfterRender",[n]),this.N=h,this.N.legend&&this.N.legend.values)for(var u=this.N.legend.values,c=0;c<u.length;c++)u[c].$hidden&&this.hideSeries(c)}},pI:function(t,i){var e={};for(var s in e.left=i.start.x,e.top=i.start.y,e.width=i.end.x-i.start.x,e.height=i.end.y-i.start.y,e)t.style[s]=e[s]+"px"},vI:function(){var t,i,e,s,n,r,h,o,a,u;if(s=this.data.getRange(),t=-1!=this.N.type.toLowerCase().indexOf("barh")?"yAxis":"xAxis",(i=this.N[t])&&i.units&&"object"==M(i.units)){if(o=[],"undefined"!=typeof(e=i.units).start&&"undefined"!=typeof e.end&&"undefined"!=typeof e.next)for(h=e.start;h<=e.end;)o.push(h),h=e.next.call(this,h);else"[object Array]"===Object.prototype.toString.call(e)&&(o=e);if(r=[],o.length){for(a=i.value,u={},n=0;n<s.length;n++)u[a(s[n])]=n;for(n=0;n<o.length;n++)"undefined"!=typeof u[o[n]]?(s[u[o[n]]].$unit=o[n],r.push(s[u[o[n]]])):r.push({$unit:o[n]})}return r}return s},series_setter:function(t){if(t&&"object"==M(t)){this.Et(t.length?t[0]:t),this.cD=[this.N];for(var i=1;i<t.length;i++)this.addSeries(t[i])}else;return t},value_setter:Lt,xValue_setter:Lt,yValue_setter:function(t){this.define("value",t)},alpha_setter:Lt,label_setter:Lt,lineColor_setter:Lt,borderColor_setter:Lt,pieInnerText_setter:Lt,donutInnerText_setter:Lt,gradient_setter:function(t){return"function"!=typeof t&&t&&!0===t&&(t="light"),t},colormap:{RAINBOW:function(t){var i=Math.floor(this.getIndexById(t.id)/this.count()*1536);return 1536==i&&(i-=1),this.bI[Math.floor(i/256)](i%256)},"default":function(t){var i=this.count(),e=this.tf.length,s=this.getIndexById(t.id);return i<e?(s&&(s=s<e-i?this.Qc+2:this.Qc+1),this.Qc=s):s%=e,this.tf[s]}},color_setter:function(t){return this.colormap[t]||Lt(t)},fill_setter:function(t){return!(!t||"0"==t)&&Lt(t)},lI:function(t){this.define("preset",t.preset),delete t.preset},preset_setter:function(t){var i,e,s;if(this.defaults=F.extend({},this.defaults),"object"!=M(s=this.presets[t]))return!1;for(i in s)if("object"==M(s[i]))if(this.defaults[i]&&"object"==M(this.defaults[i]))for(e in this.defaults[i]=F.extend({},this.defaults[i]),s[i])this.defaults[i][e]=s[i][e];else this.defaults[i]=F.extend({},s[i]);else this.defaults[i]=s[i];return t},legend_setter:function(t){return t?("object"!=M(t)&&(t={template:t}),this.ji(t,{width:150,height:18,layout:"y",align:"left",valign:"bottom",template:"",toggle:-1!=this.N.type.toLowerCase().indexOf("stacked")?"":"hide",marker:{type:"square",width:15,height:15,radius:3},margin:4,padding:3}),t.template=Lt(t.template),t):(this.dI&&(this.dI.innerHTML="",this.dI=null),!1)},item_setter:function(t){"object"!=M(t)&&(t={color:t,borderColor:t}),this.ji(t,F.extend({},this.defaults.item));return this.mI(["alpha","borderColor","color","radius","type"],t),t},line_setter:function(t){
return"object"!=M(t)&&(t={color:t}),(t=F.extend(t,this.defaults.line)).color=Lt(t.color),t},padding_setter:function(t){return"object"!=M(t)&&(t={left:t,right:t,top:t,bottom:t}),this.ji(t,{left:50,right:20,top:35,bottom:40}),t},xAxis_setter:function(t){if(!t)return!1;"object"!=M(t)&&(t={template:t}),this.ji(t,{title:"",color:"#edeff0",lineColor:"#edeff0",template:"{obj}",lines:!0});return this.mI(["lineColor","template","lines"],t),this.HD=F.extend({},t),t},yAxis_setter:function(t){this.ji(t,{title:"",color:"#edeff0",lineColor:"#edeff0",template:"{obj}",lines:!0,bg:te.backColor});return this.mI(["lineColor","template","lines","bg"],t),this.qD=F.extend({},t),t},mI:function(t,i){for(var e=0;e<t.length;e++)i[t[e]]=Lt(i[t[e]])},FD:function(t,i,e,s,n){var r={container:e||this.qi,name:t,title:V(n)?t:n||"",series:s,style:i||"",width:this.xe,height:this.Me};return new Zi(r)},oD:function(t,i,e,s,n,r){var h,o=0;return this.N.yAxis&&(this.canvases.y||(this.canvases.y=this.FD("axis_y")),o=this.XD(this.canvases.y.getCanvas(),t,i,e,s,n)),this.N.xAxis&&(this.canvases.x||(this.canvases.x=this.FD("axis_x")),h=this.canvases.x.getCanvas(),this.callEvent("onBeforeXAxis",[h,t,i,e,r,o])&&this.uD(h,t,i,e,r,o)),o},uD:function(t,i,e,s,n,r){var h,o,a=this.N,u=e.x-.5,c=parseInt(r||s.y,10)+.5,f=s.x,l=!0,d="stackedBar"==a.type?s.y+.5:c;for(h=0;h<i.length;h++){!0===a.offset?o=u+n/2+h*n:(o=h!=i.length-1||a.cellWidth?u+h*n:s.x,l=!!h),o=Math.ceil(o)-.5;var v="auto"!=a.origin&&"bar"==a.type&&parseFloat(a.value(i[h]))<a.origin;this.uI(o,d,i[h],l,v),(a.offset||h||a.cellWidth)&&a.xAxis.lines.call(this,i[h])&&this.cI(t,o,s.y,e.y,i[h])}this.canvases.x.renderTextAt(!0,!1,u,s.y+a.padding.bottom-3,a.xAxis.title,"webix_axis_title_x",s.x-e.x),this.sD(t,u,c,f,c,a.xAxis.color,1),a.xAxis.lines.call(this,{})&&a.offset&&this.sD(t,f+.5,s.y,f+.5,e.y+.5,a.xAxis.lineColor.call(this,{}),1)},XD:function(t,i,e,s,n,r){var h,o={};if(this.N.yAxis){var a=e.x-.5,u=s.y,c=e.y,f=s.y+.5;if(this.N.yAxis.step&&(h=parseFloat(this.N.yAxis.step)),"undefined"==typeof this.qD.step||"undefined"==typeof this.qD.start||"undefined"==typeof this.qD.end?(n=(o=this.RD(n,r)).start,r=o.end,h=o.step,this.N.yAxis.end=r,this.N.yAxis.start=n):"logarithmic"==this.config.scale&&(this.fD=!0),this.BD(e,s),0!==h){if(r==n)return u;for(var l=(u-c)*h/(r-n),d=0,v=this.N.origin,_=n;_<=r;_+=h){var p=this.fD?Math.pow(10,_):_;o.fixNum&&(p=parseFloat(p).toFixed(o.fixNum));var b=Math.floor(u-d*l)+.5;if(_==n&&"auto"==v||!this.N.yAxis.lines.call(this,_)||this.sD(t,a,b,s.x,b,this.N.yAxis.lineColor.call(this,_),1),"auto"!=v&&_<=v&&v<_+h&&(f=b-l*(v-p)/h),h<1&&!this.fD){var m=Math.min(Math.floor(this.lD(h)),n<=0?0:Math.floor(this.lD(n))),g=Math.pow(10,-m);_=p=Math.round(p*g)/g}this.canvases.y.renderText(0,b-5,this.N.yAxis.template(p.toString()),"webix_axis_item_y",e.x-5),d++}return this.sD(t,a,u+1,a,c,this.N.yAxis.color,1),f}}},BD:function(t,i){var e=this.canvases.y.renderTextAt("middle",!1,0,parseInt((i.y-t.y)/2+t.y,10),this.N.yAxis.title,"webix_axis_title_y");e&&(e.style.left=(e.offsetHeight-e.offsetWidth)/2+"px")},gI:function(t,i){return{start:Math.floor(this.lD(t)),step:1,end:Math.ceil(this.lD(i))}},wI:function(t){var i=Math.floor(this.lD(t)),e=Math.pow(10,i),s=t/e;return s=5<s?10:5,parseInt(s,10)*e},RD:function(t,i){if(this.fD=!1,"logarithmic"==this.N.scale){var e=Math.floor(this.lD(t)),s=Math.ceil(this.lD(i));if(0<t&&0<i&&1<s-e)return this.fD=!0,this.gI(t,i)}var n,r;"auto"!=this.N.origin&&this.N.origin<t&&(t=this.N.origin);var h=this.wI((i-t)/8||1),o=Math.floor(this.lD(h));if(h>Math.abs(t))n=t<0?-h:0;else{var a=Math.abs(t),u=Math.floor(this.lD(a)),c=a/Math.pow(10,u);for(n=0!=u||.1<=h?Math.ceil(10*c)/10*Math.pow(10,u)-h:a,1<a&&.1<h&&(n=Math.ceil(n));t<0?n<=t:t<=n;)n-=h;t<0&&(n=-n-2*h),n-=n%h,n=parseFloat((1*n).toFixed(Math.abs(o)))}for(10<i-n&&(h=this.wI((i-n)/8||1)),r=n,0==i&&i==t&&(i=h);r<i;)r+=h,r=parseFloat((1*r).toFixed(Math.abs(o)));return{start:n,end:r,step:h,fixNum:o<0?Math.abs(o):0}},hD:function(t,i){var e,s,n=this.data.uo(),r=arguments.length&&"h"==t?this.HD:this.qD;if(i=i||"value",
r&&"undefined"!=typeof r.end&&"undefined"!=typeof r.start&&r.step)e=parseFloat(r.end),s=parseFloat(r.start);else if(e=He.max(this.cD[0][i],n),s=r&&"undefined"!=typeof r.start?parseFloat(r.start):He.min(this.cD[0][i],n),1<this.cD.length)for(var h=1;h<this.cD.length;h++){var o=He.max(this.cD[h][i],n),a=He.min(this.cD[h][i],n);e<o&&(e=o),a<s&&(s=a)}return{max:e,min:s}},lD:function(t){return Math.log(t)/Math.LN10},uI:function(t,i,e,s,n){if(this.N.xAxis){var r=this.canvases.x.renderTextAt(n,s,t,i-(n?2:0),this.N.xAxis.template(e));r&&(r.className+=" webix_axis_item_x")}},cI:function(t,i,e,s,n){this.N.xAxis&&this.N.xAxis.lines&&this.sD(t,i,e,i,s,this.N.xAxis.lineColor.call(this,n),1)},sD:function(t,i,e,s,n,r,h){t.strokeStyle=r,t.lineWidth=h,t.beginPath(),t.moveTo(i,e),t.lineTo(s,n),t.stroke(),t.lineWidth=1},aD:function(t,i){return[i!=t?i-t:t,1]},bI:[function(t){return"#FF"+Ze.toHex(t/2,2)+"00"},function(t){return"#FF"+Ze.toHex(t/2+128,2)+"00"},function(t){return"#"+Ze.toHex(255-t,2)+"FF00"},function(t){return"#00FF"+Ze.toHex(t,2)},function(t){return"#00"+Ze.toHex(255-t,2)+"FF"},function(t){return"#"+Ze.toHex(t,2)+"00FF"}],tf:["#f55b50","#ff6d3f","#ffa521","#ffc927","#ffee54","#d3e153","#9acb61","#63b967","#21a497","#21c5da","#3ea4f5","#5868bf","#7b53c0","#a943ba","#ec3b77","#9eb0b8"],Qc:0,addSeries:function(t){var i=this.N;this.N=F.extend({},i),this.Et(t),this.cD.push(this.N),this.N=i},$tooltipIn:function(t){return t},ze:function(t,i){var e=this.locate(i);if(!e)return null;var s=this.xI(i),n=F.extend({dx:20,dy:0,template:"{obj.value}",css:""},this.cD[s].tooltip||{template:""},!0);return ni.Lt.define(n),this.getItem(e)},xI:function(t){var i,e,s,n,r,h,o,a;for(e=this.wu.xu,n=at(this.qi.Oi),o=(r=ct(t)).x-n.x,a=r.y-n.y,s=0;s<e.length;s++)o<=(i=e[s].points)[2]&&o>=i[0]&&a<=i[3]&&a>=i[1]&&(h?e[s].index>h.index&&(h=e[s]):h=e[s]);return h?h.index:0},hideSeries:function(t){this.canvases[t].hideCanvas();var i=this.N.legend;i&&i.values&&i.values[t]&&(i.values[t].$hidden=!0,this._I()),this.wu.hide(this.qi,t,!0)},showSeries:function(t){this.canvases[t].showCanvas();var i=this.N.legend;i&&i.values&&i.values[t]&&(delete i.values[t].$hidden,this._I()),this.wu.hide(this.qi,t,!1)},_I:function(t,i){var e,s,n,r,h,o,a,u,c,f,l,d=0,v=0;if(t=t||[],i=i||this.xe,u=this.canvases.legend.getCanvas(),s=this.N.legend,a="x"!=this.N.legend.layout?"width:"+s.width+"px":"",this.dI&&(this.dI.innerHTML="",this.dI.parentNode.removeChild(this.dI)),this.canvases.legend.clearCanvas(!0),n=st("DIV",{"class":"webix_chart_legend",style:"left:"+d+"px; top:"+v+"px;"+a},""),s.padding&&(n.style.padding=s.padding+"px"),this.dI=n,this.qi.appendChild(n),h=[],s.values)for(e=0;e<s.values.length;e++)h.push(this.yI(n,s.values[e].text,"undefined"!=typeof s.values[e].id?M(s.values[e].id):e,s.values[e].$hidden));else for(e=0;e<t.length;e++)h.push(this.yI(n,s.template(t[e]),t[e].id));var _,p,b=document.body.contains(this.qi);for(b||(p=st("DIV",{style:"visibility:hidden; position:absolute; top:0px; left:0px;"},""),_=this.qi.parentNode,document.body.appendChild(p),p.appendChild(this.qi)),o=n.offsetWidth,r=n.offsetHeight,o<i&&("x"==s.layout&&"center"==s.align&&(d=(i-o)/2),"right"==s.align&&(d=i-o),s.margin&&"center"!=s.align&&(d+=("left"==s.align?1:-1)*s.margin)),r<this.Me&&("middle"==s.valign&&"center"!=s.align&&"x"!=s.layout?v=(this.Me-r)/2:"bottom"==s.valign&&(v=this.Me-r),s.margin&&"middle"!=s.valign&&(v+=("top"==s.valign?1:-1)*s.margin)),n.style.left=d+"px",n.style.top=v+"px",u.save(),e=0;e<h.length;e++)l=h[e],c=s.values&&s.values[e].$hidden?(f=!0,s.values[e].disableColor?s.values[e].disableColor:"#edeff0"):(f=!1,s.values?s.values[e].color:this.N.color.call(this,t[e])),this.MI(u,l.offsetLeft+d,l.offsetTop+v,c,l.offsetHeight,f,e);u.restore(),b||(_.appendChild(this.qi),rt(p)),h=null},yI:function(t,i,e,s){var n="";"x"==this.N.legend.layout&&(n="float:left;");var r=st("DIV",{style:n+"padding-left:"+(10+this.N.legend.marker.width)+"px","class":"webix_chart_legend_item"+(s?" hidden":""),role:"button",tabindex:"0","aria-label":B.aria[(s?"show":"hide")+"Chart"]+" "+i},i)
;return 2<arguments.length&&r.setAttribute("series_id",e),t.appendChild(r),r},MI:function(t,i,e,s,n,r,h){var o=[],a=this.N.legend.marker,u=this.N.legend.values,c=u&&u[h].markerType?u[h].markerType:a.type;if(s&&(t.strokeStyle=t.fillStyle=s),"round"!=c&&a.radius)if("item"==c){if(this.N.line&&"scatter"!=this.N.type&&!this.N.disableLines){t.beginPath(),t.lineWidth=this.cD[h].line.width,t.strokeStyle=r?s:this.cD[h].line.color.call(this,{});var f=i+5,l=e+n/2;t.moveTo(f,l);var d=f+a.width;t.lineTo(d,l),t.stroke()}var v=this.cD[h].item,_=parseInt(v.radius.call(this,{}),10)||0,p=v.type.call(this,{});_&&(t.beginPath(),r?(t.lineWidth=v.borderWidth,t.strokeStyle=s,t.fillStyle=s):(t.lineWidth=v.borderWidth,t.fillStyle=v.color.call(this,{}),t.strokeStyle=v.borderColor.call(this,{}),t.globalAlpha=v.alpha.call(this,{})),t.beginPath(),i+=a.width/2+5,e+=n/2,this.SD(t,i,e,_+1,p),t.fill(),t.stroke()),t.globalAlpha=1}else t.beginPath(),t.lineWidth=1,i+=5,e+=n/2-a.height/2,o=[[i+a.radius,e+a.radius,a.radius,Math.PI,3*Math.PI/2,!1],[i+a.width-a.radius,e],[i+a.width-a.radius,e+a.radius,a.radius,-Math.PI/2,0,!1],[i+a.width,e+a.height-a.radius],[i+a.width-a.radius,e+a.height-a.radius,a.radius,0,Math.PI/2,!1],[i+a.radius,e+a.height],[i+a.radius,e+a.height-a.radius,a.radius,Math.PI/2,Math.PI,!1],[i,e+a.radius]],this.kD(t,o),t.stroke(),t.fill();else{t.beginPath();var b=a.height/2;t.arc(i+b+5,e+n/2,b,0,2*Math.PI),t.fill()}},nI:function(t,i){var e,s,n,r;if(e=this.N.padding.left,s=this.N.padding.top,n=t-this.N.padding.right,r=i-this.N.padding.bottom,this.N.legend){var h=this.N.legend,o=this.N.legend.width,a=this.N.legend.height;"x"==h.layout?"center"==h.valign?"right"==h.align?n-=o:"left"==h.align&&(e+=o):"bottom"==h.valign?r-=a:s+=a:"right"==h.align?n-=o:"left"==h.align&&(e+=o)}return{start:{x:e,y:s},end:{x:n,y:r}}},CD:function(t){var i,e,s,n,r;if(this.N.yAxis&&"undefined"!=typeof this.N.yAxis.end&&"undefined"!=typeof this.N.yAxis.start&&this.N.yAxis.step)s=parseFloat(this.N.yAxis.end),n=parseFloat(this.N.yAxis.start);else{for(i=0;i<t.length;i++)for(t[i].$sum=0,t[i].$min=Infinity,e=0;e<this.cD.length;e++)r=Math.abs(parseFloat(this.cD[e].value(t[i])||0)),isNaN(r)||(-1!=this.cD[e].type.toLowerCase().indexOf("stacked")&&(t[i].$sum+=r),r<t[i].$min&&(t[i].$min=r));for(s=-Infinity,n=Infinity,i=0;i<t.length;i++)t[i].$sum>s&&(s=t[i].$sum),t[i].$min<n&&(n=t[i].$min);0<n&&(n=0)}return{max:s,min:n}},mD:function(t,i,e,s,n,r,h,o){var a,u,c,f,l,d;return"light"==r?(a="x"==o?t.createLinearGradient(i,e,s,e):t.createLinearGradient(i,e,i,n),d=[[0,"#FFFFFF"],[.9,h],[1,h]],u=2):"falling"==r||"rising"==r?(a="x"==o?t.createLinearGradient(i,e,s,e):t.createLinearGradient(i,e,i,n),c=Ze.toRgb(h),(f=Ze.rgbToHsv(c[0],c[1],c[2]))[1]*=.5,l="rgb("+Ze.hsvToRgb(f[0],f[1],f[2])+")","falling"==r?d=[[0,l],[.7,h],[1,h]]:"rising"==r&&(d=[[0,h],[.3,h],[1,l]]),u=0):(t.globalAlpha=.37,u=0,a="x"==o?t.createLinearGradient(i,n,i,e):t.createLinearGradient(i,e,s,e),d=[[0,"#9d9d9d"],[.3,"#e8e8e8"],[.45,"#ffffff"],[.55,"#ffffff"],[.7,"#e8e8e8"],[1,"#9d9d9d"]]),this.SI(a,d),{gradient:a,offset:u}},hf:function(t,i,e,s){return t*=-1,{x:i+=Math.cos(t)*s,y:e-=Math.sin(t)*s}},SI:function(t,i){for(var e=0;e<i.length;e++)t.addColorStop(i[e][0],i[e][1])},kD:function(t,i){var e,s;for(e=0;e<i.length;e++)s=e?"lineTo":"moveTo",2<i[e].length&&(s="arc"),t[s].apply(t,i[e])},kI:function(t,i,e,s,n){t.addRect(i,[e[0].x-s.x,e[0].y-s.y,e[1].x-s.x,e[1].y-s.y],n)}},vo={api:lo,view:F.protoUI(lo,Qh,to,io,eo,so,no,{$render_spline:function(t,i,e,s,n,r){var h,o,a,u,c,f,l,d,v,_,p,b,m;if(c=this.gD(t,i,e,s,n),h=this.N,this.yD=e,a=[],i.length){for(d=h.offset?e.x+.5*c.cellWidth:e.x,o=0;o<i.length;o++)((p=this.wD(i[o],e,s,c))||"0"==p)&&(l=o?c.cellWidth*o-.5+d:d,a.push({x:l,y:p,v:this.N.value(i[o]),index:o}));for(f=this.iI(a),o=0;o<a.length;o++){if(v=a[o].x,b=a[o].y,o<a.length-1){for(_=a[o+1].x,m=a[o+1].y,u=v;u<_;u++){var g=this.eI(u,v,o,f.a,f.b,f.c,f.d);g<e.y&&(g=e.y),g>s.y&&(g=s.y);var w=this.eI(u+1,v,o,f.a,f.b,f.c,f.d);w<e.y&&(w=e.y),w>s.y&&(w=s.y),this.sD(t,u,g,u+1,w,h.line.color(i[o]),h.line.width)}this.sD(t,_-1,this.eI(u,v,o,f.a
,f.b,f.c,f.d),_,m,h.line.color(i[o]),h.line.width)}this.MD(t,v,b,i[a[o].index],h.label(i[a[o].index]),n,r)}}},iI:function(t){var i,e,s,n,r,h,o,a,u=[],c=[],f=t.length;for(r=0;r<f-1;r++)u[r]=t[r+1].x-t[r].x,c[r]=(t[r+1].y-t[r].y)/u[r];for(a=[],(o=[])[0]=0,o[1]=2*(u[0]+u[1]),a[0]=0,a[1]=6*(c[1]-c[0]),r=2;r<f-1;r++)o[r]=2*(u[r-1]+u[r])-u[r-1]*u[r-1]/o[r-1],a[r]=6*(c[r]-c[r-1])-u[r-1]*a[r-1]/o[r-1];for((h=[])[f-1]=h[0]=0,r=f-2;1<=r;r--)h[r]=(a[r]-u[r]*h[r+1])/o[r];for(i=[],e=[],s=[],n=[],r=0;r<f-1;r++)i[r]=t[r].y,e[r]=-u[r]*h[r+1]/6-u[r]*h[r]/3+(t[r+1].y-t[r].y)/u[r],s[r]=h[r]/2,n[r]=(h[r+1]-h[r])/(6*u[r]);for(r=0;r<t.length-1;r++)0===t[r].v&&0===t[r+1].v&&(i[r]=t[r].y,n[r]=s[r]=e[r]=0);return{a:i,b:e,c:s,d:n}},eI:function(t,i,e,s,n,r,h){return s[e]+(t-i)*(n[e]+(t-i)*(r[e]+(t-i)*h[e]))}},ro,ho,oo,{presets:{simple:{item:{borderColor:"#ffffff",color:"#2b7100",shadow:!1,borderWidth:2},line:{color:"#8ecf03",width:2}},plot:{color:"#8664C6",item:{borderColor:"#8664C6",borderWidth:1,color:"#ffffff",type:"r",shadow:!1},line:{color:"#8664C6",width:2}},diamond:{color:"#FF5C4C",item:{borderColor:"#FF5C4C",color:"#FF5C4C",type:"d",radius:3,shadow:!0},line:{color:"#FF5C4C",width:2}},point:{color:"#1ca1c1",disableLines:!0,fill:!1,disableItems:!1,item:{color:"#1ca1c1",borderColor:"#1ca1c1",radius:2,borderWidth:2,type:"r"},alpha:1},line:{line:{color:"#1ca1c1",width:2},item:{color:"#ffffff",borderColor:"#1ca1c1",radius:2,borderWidth:2,type:"d"},fill:!1,disableItems:!1,disableLines:!1,alpha:1},area:{fill:"#1ca1c1",line:{color:"#1ca1c1",width:1},disableItems:!0,alpha:.2,disableLines:!1},round:{item:{radius:3,borderColor:"#1ca1c1",borderWidth:1,color:"#1ca1c1",type:"r",shadow:!1,alpha:.6}},square:{item:{radius:3,borderColor:"#00a497",borderWidth:2,color:"#ffffff",type:"s",shadow:!1,alpha:1},line:{color:"#00a497"}},column:{color:"RAINBOW",gradient:!1,barWidth:45,radius:0,alpha:1,border:!0},stick:{barWidth:5,gradient:!1,color:"#1ca1c1",radius:2,alpha:1,border:!1},alpha:{color:"#b9a8f9",barWidth:70,gradient:"falling",radius:0,alpha:.5,border:!0}}},ao,uo,Ee,Ji,ke,We,v,Gi.view)},_o={name:"rangechart",$init:function(){this.attachEvent("onAfterRender",this.CI),this.$I()},CI:function(){var i=this;if(-1===this.N.type.indexOf("pie")&&"radar"!==this.N.type&&this.N.type,this.wu.xu.length&&!this.DI){this.II(),this.AI=(this.wu.xu[0].points[2]-this.wu.xu[0].points[0])/2;var t={webix_disable_drag:"true",tabindex:"0",role:"button","aria-label":B.aria.resizeChart};this.TI=st("div",F.extend({"class":"webix_chart_resizer right"},t)),this.FI=st("div",F.extend({"class":"webix_chart_resizer left"},t)),this.DI=st("div",{"class":"webix_chart_frame",webix_disable_drag:"true"}),this.zt.appendChild(this.FI),this.zt.appendChild(this.DI),this.zt.appendChild(this.TI),this.VI(),Yt(this.TI,St.mouse.down,function(t){return i.zI(t,"mouse")}),Yt(this.FI,St.mouse.down,function(t){return i.zI(t,"mouse")}),Yt(this.DI,St.mouse.down,function(t){return i.zI(t,"mouse")}),St.touch&&(Yt(this.TI,St.touch.down,function(t){return i.zI(t,"touch")}),Yt(this.FI,St.touch.down,function(t){return i.zI(t,"touch")}),Yt(this.DI,St.touch.down,function(t){return i.zI(t,"touch")})),Yt(D(this.TI),"keydown",this.BI,{bind:this}),Yt(D(this.FI),"keydown",this.BI,{bind:this}),this.d$&&(this.N.range=this.$I(this.d$)),this.HI(),this.callEvent("onAfterRangeChange",[this.d$]),this.data.attachEvent("onStoreUpdated",k(this.HI,this))}else this.VI(!0)},$setSize:function(t,i){vo.api.$setSize.call(this,t,i)&&(this.II(),this.HI())},VI:function(t){this.TI&&!this.RI&&(this.RI=this.TI.clientWidth/2,t&&this.HI())},II:function(){var t=this.nI(this.xe,this.Me);this.yD=t.start,this.EI=t.end},removeAllSeries:function(){this.DI=this.TI=this.FI=null,vo.api.removeAllSeries.apply(this,arguments)},BI:function(t){var i=t.which||t.keyCode;if(37===i||39===i){ft(t);var e=-1!==t.target.className.indexOf("right")?"eindex":"sindex",s=-1!==t.target.className.indexOf("right")?"end":"start",n=this.d$;n[e]=n[e]+(37===i?-1:1),this.wu.xu[n[e]]&&(n[s]=this.jI(n[e]),this.setFrameRange(n))}},zI:function(t,i){var e=this;if(
-1!==t.target.className.indexOf("webix_chart_resizer"))this.NI=t.target;else if(this.wu.xu.length){var s=this.wu.xu[this.d$.sindex].points[2]-this.AI,n=this.wu.xu[this.d$.eindex].points[2]-this.AI;this.LI={ex:ct(t).x,fx:s+this.yD.x,fw:n-s}}vt(this.zt,"webix_noselect webix_wresize_cursor"),this.OI();var r="touch"===i?{passive:!1}:null;this.WI=Gt(document.body,St[i].move,function(t){return e.UI(t,i)},r),this.qI=Gt(document,St[i].up,function(t){return e.YI(t,i)})},OI:function(){this.WI&&(Xt(this.WI),Xt(this.qI),this.qI=this.WI=null)},UI:function(t,i){if(this.NI){var e=ct(t).x-at(this.$view).x;e>=this.yD.x&&e<=this.EI.x&&(-1!==this.NI.className.indexOf("left")?e<this.TI.offsetLeft&&(this.NI.style.left=e-this.RI+"px",this.DI.style.left=e+"px",this.DI.style.width=this.TI.offsetLeft-this.FI.offsetLeft-1+"px"):e>this.FI.offsetLeft+this.RI&&(this.NI.style.left=e-this.RI+"px",this.DI.style.width=this.TI.offsetLeft-this.FI.offsetLeft-1+"px"))}else if(this.LI){var s=ct(t).x-this.LI.ex,n=this.LI.fx+s,r=n+this.LI.fw;this.yD.x<=n&&this.EI.x>=r&&(F.extend(this.LI,{lx:n,rx:r},!0),this.FI.style.left=n-this.RI+"px",this.TI.style.left=r-this.RI+"px",this.DI.style.left=n+"px")}"touch"===i&&ft(t)},YI:function(t,i){if(this.OI(),_t(this.zt,"webix_noselect"),_t(this.zt,"webix_wresize_cursor"),this.count()){if(this.NI){var e="touch"===i?t.changedTouches[0].pageX:ct(t).x;e-=at(this.$view).x+this.yD.x;var s=this.GI(e),n=this.jI(s);this.NI===this.FI?(s>=this.d$.eindex&&(s=this.d$.eindex,n=this.jI(s)),this.d$.start=n,this.d$.sindex=s):(s<=this.d$.sindex&&(s=this.d$.sindex,n=this.jI(s)),this.d$.end=n,this.d$.eindex=s),this.NI=null}else if(this.LI&&this.LI.lx){var r=this.d$.sindex=this.GI(this.LI.lx-this.yD.x),h=this.d$.eindex=this.GI(this.LI.rx-this.yD.x);this.d$.start=this.jI(r),this.d$.end=this.jI(h),this.LI=null}this.HI(),this.callEvent("onAfterRangeChange",[this.d$.start,this.d$.end])}},jI:function(t){return t>=this.data.order.length&&(t=this.data.order.length-1),this.getItem(this.data.order[t])[this.N.frameId||"id"]},GI:function(t){for(var i=this.wu.xu,e=0;e<i.length;e++)if(t<=i[e].points[2]-this.AI)return e;return i.length-1},XI:function(t){for(var i=this.N.frameId||"id",e=0;e<this.data.order.length;e++)if(this.getItem(this.data.order[e])[i]==t)return e;return-1},$I:function(t){t?(t.start&&(t.sindex=this.XI(t.start)),t.end&&(t.eindex=this.XI(t.end)),t.start=t.start||this.jI(t.sindex),t.end=t.end||this.jI(t.eindex)):t={start:0,end:0,sindex:0,eindex:0},this.d$=t},range_setter:function(t){return this.$I(t),this.d$},getFrameData:function(){for(var t=[],i=this.d$.sindex;i<=this.d$.eindex;i++){var e=this.getItem(this.data.order[i]);e&&t.push(e)}return t},setFrameRange:function(t){this.$I(t),this.HI(),this.callEvent("onAfterRangeChange",[t])},HI:function(){if(this.wu){var t=this.wu.xu;if(t.length){var i=t[this.d$.sindex].points[0]+this.yD.x+this.AI-1,e=t[this.d$.eindex].points[0]+this.yD.x+this.AI-1;this.FI.style.left=i-this.RI+"px",this.TI.style.left=e-this.RI+"px",this.DI.style.left=i+"px",this.DI.style.width=e-i+"px",this.N.range=this.d$}}},getFrameRange:function(){return this.N.range}},po=(F.protoUI(_o,vo.view),{name:"grouplist",defaults:{animate:{}},Wm:"webix_grouplist",$init:function(){F.extend(this.data,Ms,!0),this.data.count=function(){return this.order.length},this.data.provideApi(this,!0),this.data.attachEvent("onClearAll",k(this.KI,this)),this.KI()},KI:function(){this.JI=[],this.ZI=[]},$setSize:function(){Gi.api.$setSize.apply(this,arguments)&&(this.it.style.width=this.xe)},on_click:{webix_list_item:function(t,i){return!this.t_&&(this.hh(i)||this.Tu(i)?this.render():void(this.N.select&&(this.qm=!0,"multiselect"==this.N.select||this.N.multiselect?this.select(i,!1,"touch"==this.N.multiselect||t.ctrlKey||t.metaKey,t.shiftKey):this.select(i),this.qm=!1)))}},hh:function(t){for(var i=0;i<this.ZI.length;i++)if(this.ZI[i]==t){for(var e=i;e<this.ZI.length;e++)this.data.getItem(this.ZI[e]).$template="";return i?(this.JI=this.data.branch[this.ZI[i-1]],this.ZI.splice(i)):(this.JI=this.data.branch[0],this.ZI=[]),!(this.QI=!1)}},Tu:function(t){
var i=this.getItem(t);if(i.$count&&-1===x.find.call(this.ZI,t))return i.$template="Back",this.JI=this.data.branch[i.id],this.ZI.push(t),this.QI=!0},getOpenState:function(){return{parents:this.ZI,branch:this.JI}},setOpenState:function(t){var i=0;if(t){var e=this.getItem(t);i=e.$count?e.id:e.$parent}for(this.JI=this.data.branch[i],this.ZI=[];i;)this.getItem(i).$template="Back",this.ZI.unshift(i),i=this.getItem(i).$parent;this.qm=!0,this.render(),this.qm=!1},render:function(t,i,e){var s,n,r=this,h=arguments;if(this.ZI=S(this.ZI),this.JI=S(this.JI),this.ZI.length)for(s=0;s<this.ZI.length;s++)this.data.branch[this.ZI[s]]||(this.ZI.splice(s,1),s--);if(n=this.ZI.length?this.ZI[this.ZI.length-1]:0,this.JI=S(this.data.branch[n]),!this.JI.length&&this.ZI.length&&(this.JI=[n],this.ZI.pop()),this.t_)return this.t_.then(function(){return r.render.apply(r,h)});for(s=0;s<this.JI.length;s++)this.data.getItem(this.JI[s]).$template="";if(this.JI.length||(this.JI=this.data.branch[0]),this.data.order=T([].concat(this.ZI).concat(this.JI)),this.callEvent("onBeforeRender",[this.data])){if(!this.qm&&this.it.innerHTML&&this.N.animate&&this.tA!=this.ZI.length){if(this.callEvent("onBeforeRender",[this.data])){this.iA||(this.iA=[]);var o=this.it.cloneNode(!1);o.innerHTML=this.data.getRange().map(this.tt,this).join("");var a=F.extend({},this.N.animate);a.direction=this.QI?"left":"right";var u,c=[l(a),l(a)];this.QI?this.iA.push(this.getScrollState()):u=this.iA.pop();var f=Qi.formLine(o,this.it,a);a.master=this,a.callback=function(){this.it=o,this.QI?this.scrollTo(0,0):u&&this.scrollTo(0,u.y),Qi.breakLine(f),a.master=a.callback=null,this.Oi=this.t_=null,a.wait_animation.resolve(),this.callEvent("onAfterRender",[])},Qi(f,c),this.t_=a.wait_animation=b.defer()}}else{if(t&&"delete"!==e&&-1===this.data.getIndexById(t))return;Xe.render.apply(this,arguments)}this.tA=this.ZI.length}},templateBack_setter:function(t){this.type.templateBack=Lt(t)},templateItem_setter:function(t){this.type.templateItem=Lt(t)},templateGroup_setter:function(t){this.type.templateGroup=Lt(t)},type:{template:function(t,i){return t.$count?i.templateGroup(t,i):i.templateItem(t,i)},css:"group",classname:function(t,i,e){return"webix_list_item webix_"+(t.$count?"group":"item")+(t.$template?"_back":"")+(e&&e.webix_selected?" webix_selected":"")+(i.css?" "+i.css:"")+(t.$css?" "+t.$css:"")},templateStart:Lt('<div webix_l_id="#id#" class="{common.classname()}" style="width:{common.widthSize()}; height:{common.heightSize()};  overflow:hidden;" {common.aria()}>'),templateBack:Lt("#value#"),templateItem:Lt("#value#"),templateGroup:Lt("#value#"),templateEnd:function(t){var i="";return t.$count&&(i+="<div class='webix_arrow_icon'></div>"),i+="</div>"}},showItem:function(t){-1===this.data.getIndexById(t)&&this.setOpenState(t),Xe.showItem.call(this,t)}});Kt(F.protoUI(po,Ee,Kr.view),{});var bo={name:"unitlist",_id:"webix_item_id",uniteBy_setter:Lt,render:function(t,i,e){var s=this.N;if(this.isVisible(s.id)&&s.uniteBy){if(t){var n=this.getItemNode(t);if(n&&"update"==e&&this.N.uniteBy.call(this,i)==this.getItem(t).$unitValue)return ht(this.Oi[t]=this.Dc(i),n),void rt(n)}this.callEvent("onBeforeRender",[this.data])&&(this.units=null,this.eA(),this.units&&(this.callEvent("onUnits",[]),this.it.innerHTML=this.sA().map(this.tt,this).join(""),this.Oi=null),this.callEvent("onAfterRender",[]))}},getUnits:function(){var t=[];if(this.units)for(var i in this.units)t.push(i);return t},getUnitList:function(t){return this.units?this.units[t]:null},tt:function(t){var i=this.data.Vh[t.id];return!t.$template||this.type["template"+t.$template],t.$template,this.callEvent("onItemRender",[t]),t.$unit?this.type.templateStartHeader(t,this.type)+this.type.templateHeader.call(this,t.$unit)+this.type.templateEnd(t,this.type):this.type.templateStart(t,this.type,i)+(t.$template?this.type["template"+t.$template]:this.type.template)(t,this.type)+this.type.templateEnd(t,this.type)},sA:function(){var t=[],i=this.data.$min||0,e=this.data.$max||Infinity,s=0;for(var n in this.units){t.push({$unit:n});for(var r=this.units[n],
h=0;h<r.length;h++){if(s==i&&(t=[{$unit:n}]),t.push(this.getItem(r[h])),s==e)return T(t);s++}}return T(t)},eA:function(){var e=this;this.units={},this.data.each(function(t){var i=e.N.uniteBy.call(this,t);t.$unitValue=i,e.units[i]||(e.units[i]=[]),e.units[i].push(t.id)})},type:{headerHeight:20,classname:function(t,i,e){var s="webix_list_item";return i.css&&(s+=" webix_list_"+i.css+"_item"),e&&e.$css&&(s+=" "+e.$css),t.$css&&("object"==M(t.$css)&&(t.$css=tt(t.$css)),s+=" "+t.$css),s},templateHeader:function(t){return"<span class='webix_unit_header_inner'>"+t+"</span>"},templateStart:function(t,i,e){if(t.$unit)return i.templateStartHeader.apply(this,arguments);var s="width:"+i.widthSize(t,i,e)+"; height:"+i.heightSize(t,i,e)+"; overflow:hidden;"+(i.layout&&"x"==i.layout?"float:left;":"");return'<div webix_item_id="'+t.id+'" class="'+i.classname(t,i,e)+'" style="'+s+'" '+i.aria(t,i,e)+">"},templateStartHeader:function(t,i,e){var s="webix_unit_header"+(i.css?" webix_unit_header_"+i.css+"_item":""),n="width:"+i.widthSize(t,i,e)+"; height:"+i.headerHeight+"px; overflow:hidden;";return'<div webix_unit_id="'+t.$unit+'" class="'+s+'" style="'+n+'">'}},$skin:function(){Kr.api.$skin.call(this),this.type.headerHeight=te.unitHeaderHeight}};F.protoUI(bo,Kr.view);B.dbllist={selectAll:"<span class='webix_icon wxi-angle-double-right'></span>",selectOne:"<span class='webix_icon wxi-angle-right'></span>",deselectAll:"<span class='webix_icon wxi-angle-double-left'></span>",deselectOne:"<span class='webix_icon wxi-angle-left'></span>"};var mo={name:"dbllist",defaults:{borderless:!0},$init:function(){this.nA={},this.rA=k(function(t){return this.nA[t.id]},this),this.hA=k(function(t){return!this.nA[t.id]},this),this.$view.className+=" webix_dbllist",this.$ready.unshift(this.Yg)},$onLoad:function(t,i){var e=this.$$("left"),s=this.$$("right");return this.oA(function(){e.data.driver=i,e.parse(t),s.data.driver=i,s.parse(t)}),this.aA=!0,this.l$(),!0},uA:function(){if(!1===this.N.buttons)return{width:10};var t=B.dbllist,i=[this.cA("deselect_all",t.deselectAll),this.cA("select_all",t.selectAll),this.cA("deselect_one",t.deselectOne),this.cA("select_one",t.selectOne)];return i={width:120,template:i.join(""),onClick:{dbllist_button:function(t,i,e){this.getTopParentView().fA(e.getAttribute("action"))}}},this.N.buttons&&(i.template=this.N.buttons),i},cA:function(t,i){return"<button class='dbllist_button' action='"+t+"'>"+i+"</button>"},lA:function(t,i,e,s){var n={view:"list",select:"multiselect",multiselect:"touch",id:t,action:i,drag:!0,type:{margin:3,id:t},on:{onBeforeDrop:function(t){var i=t.from,e=t.to,s=i.getTopParentView();if(s===this.getTopParentView()){var n="select_one"!=e.N.action;s.select(t.source,n)}return!1},onItemDblClick:function(){return this.getTopParentView().fA(this.config.action)}}};return this.N.list&&F.extend(n,this.N.list,!0),e&&(n={rows:[{view:"label",label:e,css:"webix_inp_top_label"},n]}),s?{rows:[n,{view:"label",height:20,label:s,css:"bottom_label"}]}:n},Yg:function(){var t=[{margin:10,type:"clean",cols:[this.lA("left","select_one",this.N.labelLeft,this.N.labelBottomLeft),this.uA(),this.lA("right","deselect_one",this.N.labelRight,this.N.labelBottomRight)]}];this.cols_setter(t)},fA:function(t){var i=null,e=!1;"select_all"===t?(i=this.$$("left").data.order,e=!0):"select_one"===t?(i=this.$$("left").getSelectedId(!0),e=!0):"deselect_all"===t?(i=this.$$("right").data.order,e=!1):"deselect_one"===t&&(i=this.$$("right").getSelectedId(!0),e=!1),this.select(i,e)},select:function(t,i){var e;if("object"!==M(t)&&(t=[t]),i)for(e=0;e<t.length;e++)this.nA[t[e]]=!0;else for(e=0;e<t.length;e++)delete this.nA[t[e]];this.l$(),this.callEvent("onChange",[])},oA:function(t,i){ai(k(t,this),!1),i&&(this.$$("left").N.autoheight||this.$$("right").N.autoheight)&&this.resize()},l$:function(){var t=this.$$("left"),i=this.$$("right");t&&this.oA(function(){t.filter(this.hA),i.filter(this.rA)},!0)},focus:function(){if(!Bi.canFocus(this))return!1;Bi.setFocus(this)},value_setter:function(t){this.setValue(t)},setValue:function(t){if(this.nA={},t){"object"!==M(t)&&(
t=t.toString().split(","));for(var i=0;i<t.length;i++)this.nA[t[i]]=!0}this.l$()},getValue:function(){var t=[],i=this.$$("left");for(var e in this.nA)this.aA&&!i.data.pull[e]||t.push(e);return t.join(",")}},go=(F.protoUI(mo,Ft,Ne,$n.view),{name:"tree",defaults:{scroll:"auto",navigation:!0},$init:function(){this.zt.className+=" webix_tree",F.extend(this.data,Ms,!0),F.extend(this.on_click,ms),this.data.provideApi(this,!0),this.zt.setAttribute("role","tree")},_id:"webix_tm_id",on_context:{},on_dblclick:{webix_tree_checkbox:function(){if(this.on_click.webix_tree_checkbox)return this.on_click.webix_tree_checkbox.apply(this,arguments)}},$fixEditor:function(t){var i=this.getItemNode(t.id).querySelector("span");if(i){""===i.innerHTML&&(i.innerHTML="&nbsp;");var e=i.offsetLeft;t.node.style.width=this.$view.scrollWidth-e-10+"px",t.node.style.marginLeft=e+"px",t.node.style.left="0px"}},on_click:{webix_tree_item:function(t,i){this.N.activeTitle&&(this.getItem(i).open?this.close(i):this.open(i));if(this.N.select)if("multiselect"==this.N.select||this.N.multiselect){var e=t.ctrlKey||t.metaKey||"touch"==this.N.multiselect;if("level"==this.N.multiselect&&(e||t.shiftKey)){var s=this.getSelectedId(!0)[0];if(s&&this.getParentId(i)!=this.getParentId(s))return}this.select(i,!1,e,t.shiftKey)}else this.select(i)}},Zn:{insert:function(t){var i=this.getSelectedId()||"0";this.add({value:t},null,i)},modify:function(t){for(var i=this.getSelectedId(!0),e=0;e<i.length;e++)this.getItem(i[e]).value=t,this.refresh(i[e])},custom:function(){}},ea:!0,$dragHTML:function(t,i,e){var s="<div class='webix_tree_item'>"+this.type.template(t,this.type)+"</div>";return I(e.source)&&1<e.source.length&&(s=this.Xo(s,e.source.length)),s},ta:function(t){for(var i=t.source,e=0;e<i.length;e++)this.close(i[e])},Qo:function(t,i){var e=this.getItemNode(t);e?e.parentNode.insertBefore(re.dn[0],e):i.children[0].children[0].appendChild(re.dn[0])},type:F.extend({template:function(t,i){return(i["template"+t.level]||i.templateCommon).apply(this,arguments)},classname:function(t,i,e){var s="webix_tree_item";return t.$css&&("object"==M(t.$css)&&(t.$css=tt(t.$css)),s+=" "+t.$css),e&&e.$css&&(s+=" "+e.$css),i.css&&(s+=" "+i.css),s},aria:function(t,i,e){return'role="treeitem"'+(e&&e.webix_selected?' aria-selected="true" tabindex="0"':' tabindex="-1"')+(t.$count?'aria-expanded="'+(t.open?"true":"false")+'"':"")+'aria-level="'+t.$level+'"'},templateCommon:Lt("{common.icon()}{common.folder()}<span>#value#</span>"),templateStart:Lt('<div webix_tm_id="#id#" class="{common.classname()}" {common.aria()}>'),templateEnd:Lt("</div>"),templateCopy:Lt("#value#")},ks)}),wo=F.protoUI(go,ys,Ee,bs,$e,ws,Je,Le,We,Ke,gs,Gr.view,xs,_e,v),xo={api:go,view:wo};Kt(wo,{name:"lineTree",css:"webix_line_tree",icon:function(t,i){for(var e="",s="",n=1;n<=t.$level;n++){n==t.$level&&(s=t.$count?t.open?"webix_tree_open ":"webix_tree_close ":"webix_tree_none ");var r=i.dA(t,i,n);r&&(e+="<div class='"+s+"webix_tree_img webix_tree_"+r+"'></div>")}return e},dA:function(t,i,e){var s=i.Mf,n=xs.Re;if(0===s&&n){var r=t.$level,h=t.id;for(s=[];r;){var o=n.getParentId(h),a=n.data.branch[o];a[a.length-1]==h&&(s[r]=!0),h=o,r--}i.Mf=s}if(!s)return 0;if(e!=t.$level)return s[e]?"blank":"line1";var u=3;return t.$parent||0===t.$index&&(u=4),s[t.$level]&&(u=2),t.$count?t.open?"minus"+u:"plus"+u:"line"+u}});var yo={name:"treemap",defaults:{activeItem:!1,subRender:!0,header:!0,headerHeight:35,value:Lt("#value#"),headerTemplate:"",navigation:!0},value_setter:Lt,headerTemplate_setter:Lt,header_setter:function(t){return t&&!0!==t&&(this.type.header=t),t},$init:function(){this.$view.className+=" webix_treemap",this.zt.setAttribute("role","tree"),this.vA=document.createElement("DIV"),F.extend(this.data,Ms,!0),this.data.provideApi(this,!0),this.data.attachEvent("onClearAll",k(function(){this.Ui="",this.$values={},this.$xy={}},this)),this.attachEvent("onKeyPress",this.De)},wf:function(t){var i=this.data.Vh[t.id];this.callEvent("onItemRender",[t]);var e=t.$template?this.type["template"+t.$template].call(this,t,this.type,i):this.type.template.call(
this,t,this.type,i);return this.type.templateStart.call(this,t,this.type,i)+e+this.type.templateEnd.call(this)},_A:function(t){var i=this.getItem(t),e=this.N.headerHeight,s="<div class='webix_treemap_header' style='height:"+e+"px;line-height:"+e+"px;'>";return s+=this.type.header.call(this,i,this.type),s+="</div>"},pA:function(t){var i,e,s,n,r=[];if(!this.$width||!this.count())return this.Ui="",!1;if(t||(t=this.config.branch||0,this.Ui="",this.$values={},this.$xy={},this.$xy[t]={width:this.$width,height:this.$height,top:0,left:0},t&&this.N.header&&(this.$xy[t].height-=this.N.headerHeight,this.$xy[t].top=this.N.headerHeight,this.Ui+=this._A(t)),n=0,this.data.each(function(t){var i=this.getParentId(t.id);if(!this.data.branch[t.id]&&(s=1*this.config.value.call(this,t),!isNaN(s)&&s))for(this.$values[t.id]=s,n+=s;i;)this.$values[i]||(this.$values[i]=0),this.$values[i]+=s,i=this.getParentId(i)},this,!1,t)),this.data.eachChild(t,function(t){this.$values[t.id]&&r.push(S(t))},this),n=n||this.$values[t],r.length&&n){(e={top:(i=this.$xy[t]).top,left:i.left,dx:i.width,dy:i.height,set:[],sum:0}).dim=Math.min(e.dx,e.dy);for(var h=e.dx*e.dy/n,o=0;o<r.length;o++)r[o].$value=this.$values[r[o].id]*h;r.sort(function(t,i){return t.$value>i.$value?-1:1});for(var a=Infinity,u=0;r[u];){var c=this.bA(e,r[u]);if(c<a)e.sum+=r[u].$value,e.set.push(r[u]),a=c,u++;else{this.ab(e);var f={top:e.top,left:e.left,dx:e.dx,dy:e.dy,set:[],sum:0},l=e.sum/e.dim;e.dx>e.dy?(f.left+=l,f.dx-=l):(f.top+=l,f.dy-=l),(e=f).dim=Math.min(e.dx,e.dy),a=Infinity}}}e&&this.ab(e)},ab:function(t){var i,e,s,n,r=t.top,h=t.left;for(t.mode=t.dy<t.dx,t.contra=t.sum/t.dim,i=0;i<t.set.length;i++)e=t.set[i].id,n=t.mode?(s=t.contra,t.set[i].$value/t.contra):(s=t.set[i].$value/t.contra,t.contra),this.$xy[e]={},this.$xy[e].top=r,this.$xy[e].left=h,t.mode?r+=n:h+=s,this.$xy[e].width=s,this.$xy[e].height=n,this.Ui+=this.wf(this.getItem(e)),this.N.subRender&&this.data.branch[e]&&this.pA(e)},bA:function(t,i){var e=t.sum+i.$value,s=e*e/(t.dim*t.dim*i.$value);return t.set.length&&(s=Math.max(t.dim*t.dim*t.set[0].$value/(e*e),s)),1<s?s:1/s},Dc:function(t){return this.vA.innerHTML=this.wf(t),this.vA.firstChild},showBranch:function(t){this.N.branch=t,this.refresh()},render:function(t,i,e){if(this.isVisible(this.N.id)&&!this.$blockRender){if("update"==e){var s=this.getItemNode(t);if(s)ht(this.Oi[t]=this.Dc(i),s),rt(s)}else!this.data.branch||this.N.branch&&!this.data.branch[this.N.branch]||(this.Oi=null,this.callEvent("onBeforeRender",[]),this.pA(),this.it.innerHTML=this.Ui,this.callEvent("onAfterRender",[]));return!0}},_id:"webix_dm_id",on_click:{webix_treemap_item:function(t,i){this.N.select&&("multiselect"==this.N.select||this.N.multiselect?this.select(i,!1,t.ctrlKey||t.metaKey||"touch"==this.N.multiselect,t.shiftKey):this.select(i)),this.N.activeItem&&this.isBranch(i)&&this.showBranch(i)},webix_treemap_header_item:function(t){var i=ot(t,"webix_dm_header_id");this.define("branch",i),this.refresh()},webix_treemap_reset:function(){this.define("branch",0),this.refresh()}},on_dblclick:{},on_mouse_move:{},mA:function(t){var i="";for(var e in t)i+=e+":"+t[e]+";";return i},type:{template:Lt("#value#"),header:function(t,i){for(var e=t.id,s="<div role='button' tabindex='0' aria-label='"+B.aria.resetTreeMap+"' class='webix_treemap_reset'></div>",n=[];e;)t=this.getItem(e),n.push(i.headerItem.call(this,t,i)),e=this.getParentId(e);return n.reverse(),s+n.join("<span class='webix_icon wxi-angle-right webix_treemap_path_icon'></span>")},headerItem:function(t){var i=this.config.headerTemplate(t),e='<a role="button" tabindex="0" aria-label="'+i+'" webix_dm_header_id="'+t.id+'" class="webix_treemap_header_item">';return e+=i,e+="</a>"},classname:function(t,i,e){var s="webix_treemap_item";i.css&&(s+=" "+i.css),t.$css&&("object"==M(t.$css)&&(t.$css=tt(t.$css)),s+=" "+t.$css);var n=this.$xy[t.id];e&&e.$css&&(s+=" "+e.$css),s+=" webix_treemap_level_"+this.getItem(t.id).$level;var r=this.getParentId(t.id);if(r&&r!=this.N.branch||(s+=" webix_treemap_level_top"),this.$height-n.top-n.height<1&&(
s+=" webix_treemap_item_bottom"),this.$width-n.left-n.width<1&&(s+=" webix_treemap_item_right"),i.cssClass){var h=i.cssClass.call(this,t,i,e);h&&("object"==M(h)?s+=" "+tt(h):s+=" "+h)}return s},templateStart:function(t,i,e){var s="";if(this.$xy){var n=this.$xy[t.id];s+="width: "+n.width+"px; height: "+n.height+"px;",s+="top: "+n.top+"px; left: "+n.left+"px;"}return'<div role="treeitem" aria-level="'+t.$level+'" '+(e&&e.webix_selected?'aria-selected="true" tabindex="0"':"")+' webix_dm_id="'+t.id+'" class="'+i.classname.call(this,t,i,e)+'" style="'+s+'">'},templateEnd:Lt("</div>")}},Mo=(F.protoUI(yo,Ee,bs,Je,Le,We,Ke,gs,Gr.view,xs,_e,v),{name:"dataview",$init:function(t){t.sizeToContent&&this.$ready.unshift(this.vh);var i=t.type||t.item;t.prerender||this.defaults.prerender||i&&"auto"==i.width||"move"==t.drag||"order"==t.drag||t.autoheight||F.extend(this,Is,!0),t.autoheight&&(t.scroll=!1),i&&"tiles"==i.type&&(this.ul=i.padding||this.type.padding,this.zt.firstChild.style["float"]="left",this.zt.firstChild.style.padding=this.ul/2+"px"),this.qi.className+=" webix_dataview",this.zt.setAttribute("role","listbox")},vh:function(){var t=st("DIV",0,this.type.template({}));t.className="webix_dataview_item",t.style.position="absolute",document.body.appendChild(t),this.type.width=t.offsetWidth+this.ul,this.type.height=t.offsetHeight+this.ul,rt(t)},defaults:{scroll:!0,datafetch:50,navigation:!0},_id:"webix_l_id",lr:"webix_dataview_item",ul:0,na:"x",on_click:{webix_dataview_item:function(t,i){this.N.select&&("multiselect"==this.N.select||this.N.multiselect?this.select(i,!1,"touch"==this.N.multiselect||t.ctrlKey||t.metaKey,t.shiftKey):this.select(i))}},on_dblclick:{},on_mouse_move:{},type:{template:Lt("#value#"),templateLoading:Lt("Loading..."),width:160,height:50,padding:8,classname:function(t,i,e){var s="webix_dataview_item";return i.css&&(s+=" "+i.css),i.type&&(s+=" "+i.type),t.$css&&("object"==M(t.$css)&&(t.$css=tt(t.$css)),s+=" "+t.$css),e&&e.$css&&(s+=" "+e.$css),s},aria:function(t,i,e){return'role="option"'+(e&&e.webix_selected?' aria-selected="true" tabindex="0"':' tabindex="-1"')},templateStart:function(t,i,e){var s=i.width,n=i.height,r=0;return"tiles"==i.type&&(s-=i.padding,n-=i.padding,r=i.padding/2),'<div webix_l_id="'+t.id+'" class="'+i.classname(t,i,e)+'" '+i.aria(t,i,e)+' style="margin:'+r+"px; width:"+s+"px; height:"+n+'px; float:left; overflow:hidden;">'},templateEnd:Lt("</div>")},$dropHTML:function(){var t=this.ul;return'<div class="webix_drop_area_inner" style="width:'.concat(this.type.width-t,"px; height:").concat(this.type.height-t,"px; margin:").concat(t/2,'px"></div>')},gA:function(t){return this.N.height=this.type.height*Math.ceil(this.data.count()/Math.floor(t/this.type.width))},autoheight_setter:function(t){var s=this;return t&&(this.data.attachEvent("onStoreLoad",function(){return s.resize()}),this.data.attachEvent("onStoreUpdated",function(t,i,e){t&&"add"!==e&&"delete"!==e||s.Um()}),this.data.attachEvent("onSyncApply",function(){return s.Um()}),this.qi.style.overflowY="hidden"),t},Um:function(){this.N.autoheight&&this.resize()},$getSize:function(t,i){this.N.xCount&&"auto"!=this.type.width&&!this.wA&&(this.N.width=this.type.width*this.N.xCount+this.ul+(this.ye?St.scrollSize:0)),this.N.yCount&&"auto"!=this.type.height&&!this.xA&&(this.N.height=this.type.height*this.N.yCount+this.ul);var e=this.N.width||this.xe;return this.N.autoheight&&e&&(this.yA(),this.gA(e),this.scroll_setter(!1)),Gi.api.$getSize.call(this,t,i)},yA:function(){return this.N.yCount&&(this.xA||"auto"==this.type.height)&&(this.type.height=Math.floor((this.Me-this.ul)/this.N.yCount),this.xA=this.N.yCount),this.N.xCount&&(this.wA||"auto"==this.type.width)&&(this.type.width=Math.floor((this.xe-this.ul)/this.N.xCount),this.wA=this.N.xCount),this.xA||this.wA},$setSize:function(t,i){var e=this.N;if(Gi.api.$setSize.call(this,t,i)){if(e.autoheight&&this.gA()!=this.Me)return C(this.resize,this);(this.yA()||this.tl)&&this.render()}else(e.yCount&&e.yCount!=this.xA||e.xCount&&e.xCount!=this.wA)&&this.yA()&&this.render()}});F.protoUI(Mo,ge,$e,We,Le,Je,Ke,pe,
Gr.view);B.pager={first:"<span class='webix_icon wxi-angle-double-left'></span>",last:"<span class='webix_icon wxi-angle-double-right'></span>",next:"<span class='webix_icon wxi-angle-right'></span>",prev:"<span class='webix_icon wxi-angle-left'></span>"};var So={defaults:{size:10,page:0,group:5,template:"{common.pages()}",maxWidth:1e5,height:30,borderless:!0},name:"pager",on_click:{webix_pager_item:function(t,i){this.select(i)}},$init:function(t){this.data=this.N,this.it=this.zt,this.zt.className+=" webix_pager"+(t.autowidth?" webix_pager_auto":""),!1!==t.master&&0!==t.master||this.$ready.push(this.MA)},MA:function(){this.refresh(),this.$master={refresh:function(){},select:function(){}}},select:function(t){if(this.$master&&"pager"==this.$master.name)return this.$master.select(t);switch(t){case"next":t=this.N.page+1;break;case"prev":t=this.N.page-1;break;case"first":t=0;break;case"last":t=this.N.limit-1}t<0&&(t=0),t>=this.data.limit&&(t=this.data.limit-1);var i=this.data.page;this.callEvent("onBeforePageChange",[t,i])&&(this.data.page=1*t,this.$master.wr=0,this.refresh()&&(this.N.animate&&this._$(i,1*t,this.N.animate)||this.$master.refresh()),this.callEvent("onAfterPageChange",[t]))},_id:"webix_p_id",template_setter:Lt,type:{template:function(t,i){return t.template.call(this,t,i)},pages:function(t){var i="";if(-1==t.page)return"";t.$min=t.page-Math.round((t.group-1)/2),t.$max=t.$min+1*t.group-1,t.$min<0&&(t.$max+=-1*t.$min,t.$min=0),t.$max>=t.limit&&(t.$min-=Math.min(t.$min,t.$max-t.limit+1),t.$max=t.limit-1);for(var e=t.$min||0;e<=t.$max;e++)i+=this.button({id:e,index:e+1,selected:e==t.page?"_selected":"",label:B.aria.page+" "+(e+1)});return i},page:function(t){return t.page+1},first:function(){return this.button({id:"first",index:B.pager.first,selected:"",label:B.aria.pages[0]})},last:function(){return this.button({id:"last",index:B.pager.last,selected:"",label:B.aria.pages[3]})},prev:function(){return this.button({id:"prev",index:B.pager.prev,selected:"",label:B.aria.pages[1]})},next:function(){return this.button({id:"next",index:B.pager.next,selected:"",label:B.aria.pages[2]})},button:Lt("<button type='button' webix_p_id='{obj.id}' class='webix_pager_item{obj.selected}' aria-label='{obj.label}'>{obj.index}</button>")},clone:function(t){t.$view||(t.view="pager",t=Qt(t)),((this.kA=t).$master=this).SA()},refresh:function(){var t=this.N;t.limit=Math.ceil(t.count/t.size)||1;var i=Math.min(t.limit-1,t.page);return i!=t.page?this.$master.setPage(i):0<=(t.page=i)&&i!=t.old_page||t.limit!=t.old_limit||t.old_count!=t.count?(this.render(),this.SA(),t.old_limit=t.limit,t.old_page=t.page,t.old_count=t.count,!0):void 0},apiOnly_setter:function(t){return this.$apiOnly=t},SA:function(){this.kA&&(this.kA.N.count=this.N.count,this.kA.N.page=this.N.page,this.kA.refresh())},_$:function(t,i,e){if(t==i)return!1;if(this.CA)return this.$A&&window.clearTimeout(this.$A),this.$A=C(this._$,this,[t,i,e],100);var s=t<i?"left":"right";"top"!=e.direction&&"bottom"!=e.direction||(s=t<i?"top":"bottom"),e.flip&&(s="");var n=0,r=this.$master.it,h=!!this.$master.nt;h&&(n=(r=this.$master.nt).offsetTop,vt(this.$master.$view,"webix_animation"));var o,a=r.cloneNode(!0);a.style.width=r.style.width="100%",this.$master.refresh(),ht(a,r.nextSibling,r.parentNode),h&&(a.childNodes[1].scrollLeft=r.childNodes[1].scrollLeft);var u=!0!==e?e:{},c=F.extend({direction:s,callback:k(function(){c.callback=null,Qi.breakLine(o),this.CA=!1,this.$master.nt&&_t(this.$master.$view,"webix_animation")},this),top:n,keepViews:h},u);o=Qi.formLine(r,a,c),Qi([r,a],c),this.CA=!0}},ko=(F.protoUI(So,We,Xi,Gi.view,v),{name:"comments",defaults:{sendAction:"click",mode:"comments",highlight:!0,maxInputHeight:84},$init:function(t){this.$view.className+=" webix_comments",this.Ht=[],t.rows=[this.$configList(t)],t.moreButton||(t.moreButton=Lt(B.comments.moreComments)),t.readonly||(t.rows.push(this.$configForm(t)),this.DA()),St.mobile&&(t.keepButtonVisible=!0),this.IA(t.users),this.$ready.push(this.AA)},$exportView:function(){return this.TA},AA:function(){var e=this;this.TA=this.queryView("list"),
this.cw=this.queryView("form"),this.FA=this.queryView("button"),this.VA=this.queryView({localId:"textarea"}),this.config.mentions&&this.zA(this.config.mentions),this.TA.data.provideApi(this,!0),this.serialize=function(){var t=e.TA.serialize(),i=e.getIndexById("$more");return 0<=i&&t.splice(i,1),t},this.N.readonly||(this.ic=w("onClick",function(t){var i=si(t);i==e.VA?e.focus():i===e.FA||i===e.BA||e.HA&&i===e.HA.getList()||t&&-1!==(t.target.className||"").toString().indexOf("webix_comments_menu")||e.RA(!1)}),this.attachEvent("onDestruct",function(){y(this.ic)}),this.TA.attachEvent("onAfterScroll",function(){e.BA.hide()}))},$onLoad:function(t,i){return this.EA(t,i)},EA:function(t,i){var e=this,s=this.TA||this.queryView({view:"list"});s.data.driver=i;var n=!1;if(t="function"==typeof t.serialize?t.serialize():(n=t.more,i.getRecords(t)),this.PA){if(this.PA=!1,t.length){var r=s.data.order,h=1;if("chat"==this.N.mode)s.data.order=T([r[0]].concat(new Array(t.length),r.slice(1)));else{var o=s.getIndexById("$more");s.data.order=T(r.slice(0,o).concat(new Array(t.length),r.slice(o))),h=o}s.parse({data:t,pos:h}),n&&ye(this.TA).ignore(function(){e.TA.updateItem("$more",{value:n})}),"chat"==this.N.mode&&s.showItem(s.getIdByIndex(t.length))}t.length&&n||ye(this.TA).ignore(function(){e.TA.remove("$more")})}else n&&!s.exists("$more")&&(n={id:"$more",value:n,$css:"webix_comments_more_item"},"chat"==this.N.mode?t.unshift(n):t.push(n)),s.parse(t),"chat"==this.N.mode&&s.waitData.then(function(){return s.showItem(s.getLastId())});return!0},$skin:function(){$n.api.$skin.call(this),this.Yb=te.inputHeight+6},getUsers:function(){return this.jA},getMenu:function(){return this.BA},setCurrentUser:function(t,i){this.config.currentUser=t,this.cw.clear(i),this.TA.refresh()},edit:function(t,i){if(!this.config.readonly&&this.callEvent("onBeforeEditStart",[t])){this.RA(!0);var e=this.TA.getItem(t);this.cw.setValues(e,!1,i),this.cw.focus();var s=this.cw.elements.text.getInputNode();s.scrollTop=s.scrollHeight,gt(s,e.text.length),this.callEvent("onAfterEditStart",[t])}},NA:function(t){var i=this.cw.getValues();i.text&&(i.id?this.updateItem(i.id,i):(this.config.currentUser&&(i.user_id=this.config.currentUser),i.date=new Date,this.add(i),this.TA.showItem(i.id)),this.cw.clear("user"),t&&(this.VA.getInputNode().value=""))},LA:function(t){this.cw.getValues().id==t&&this.cw.clear("user"),this.remove(t)},RA:function(t){if(t!==this.OA){var i=this.N;t?(this.FA.getParentView().show(),this.VA.define({height:i.maxInputHeight})):(Bi.hasFocus(this.FA)&&Bi.setFocus(this.TA),i.keepButtonVisible||this.FA.getParentView().hide(),this.VA.define({height:i.minInputHeight||this.Yb})),this.VA.resize(),this.OA=t}},focus:function(){var t=this;this.RA(!0),C(function(){t.VA.focus()})},WA:function(t){t||(t=this.VA.getValue()),t&&!this.FA.isEnabled()?this.FA.enable():!t&&this.FA.isEnabled()&&this.FA.disable()},DA:function(){var e=this;this.BA=Qt({view:"contextmenu",autowidth:!0,point:!1,data:[{id:"edit",icon:"wxi-pencil",value:B.comments.edit},{id:"remove",icon:"wxi-trash",value:B.comments.remove}],on:{onShow:function(){var t=e.BA.getContext();e.TA.addCss(t.id,"active_menu")},onHide:function(){var t=e.BA.getContext();e.TA.removeCss(t.id,"active_menu")},onItemClick:function(t){var i=e.BA.getContext();e.callEvent("onBeforeMenuAction",[t,i.id])&&("edit"==t?e.edit(i.id,"user"):"remove"==t&&(B.comments.confirmMessage?Ai({text:B.comments.confirmMessage,callback:function(t){t&&e.LA(i.id)}}):e.LA(i.id)))}}}),this.Ht.push(this.BA)},$configForm:function(t){var n=this,i=B.comments,e={view:"textarea",localId:"textarea",css:"webix_comments_textarea",height:t.minInputHeight||this.Yb,name:"text",placeholder:i.placeholder,keyPressTimeout:100,on:{onTimedKeyPress:function(){n.WA()},onChange:function(t){n.WA(t)},onKeyPress:function(t,i){if(13==t){var e=n.N.sendAction,s=i.shiftKey;("enter"==e&&!s||"enter"!==e&&s)&&(ft(i),n.NA(!0))}}}};return!1!==t.highlight&&F.extend(e,{view:"texthighlight",type:"textarea",highlight:function(t){return n.UA(Lt.escape(t),!0)}},!0),{view:"form",minHeight:50,paddingX:10,elements:[
e,{hidden:!t.keepButtonVisible,cols:[{},{view:"button",disabled:!0,css:"webix_comments_send webix_primary",value:i.send,autowidth:!0,click:function(){n.NA()}}]}]}},UA:function(t,n){var r,h=this;if(-1===t.indexOf("@"))return t;"users"===this.N.highlight&&(r=this.HA&&this.HA.N.textValue||"value");var i=n?this.qA:this.YA;return t.replace(i,function(t,i,e,s){return h.GA(t,s||i,r,n)})},GA:function(t,i,e,s){return e&&!this.jA.find(function(t){return t[e]==i},!0)?t:'<span class="webix_comments_mention">'.concat(s?t:"@"+i,"</span>")},$configList:function(i){var o=this,h="webix_comments_",e={height:"auto",templateStatus:function(t){return"<span class = '"+h+"status "+t.status+"'></span>"},templateUser:function(t){var i=o.getUsers(),e=i&&i.exists(t.user_id)?i.getItem(t.user_id):{};return"<span class = '"+h+"name'>"+(e.value||"")+"</span>"},templateMenu:function(){return o.config.readonly?"":"<span class='webix_icon wxi-dots "+h+"menu'></span>"},templateDate:function(t){var i=en.dateToStr("%d %M, %H:%i");return t.date?"<span class='"+h+"date'>"+i(t.date)+"</span>":""},templateLinks:function(t){return t.text.replace(/(https?:\/\/[^\s]+)/g,function(t){var i="<a target='_blank' href='"+(t=Lt.escape(t))+"'>";return t.match(/.(jpg|jpeg|png|gif)$/)?i+="<img class='webix_comments_image' src='"+t+"'/>":i+=t,i+"</a>"})},templateMentioned:function(t){var i=t.text;return o.N.mentions&&o.N.highlight&&(i=o.UA(t.text)),i},templateText:function(t){return"<div class = '"+h+"message'>"+t.text+"</div>"},templateAvatar:function(t,i){var e="<div class='"+h+"avatar'>",s=o.getUsers(),n=s&&s.exists(t.user_id)?s.getItem(t.user_id):{};if(n.status&&(e+=i.templateStatus(n)),e+="<div class='"+h+"avatar_image ",n.image)e+="'><img src = '"+n.image+"' class='"+h+"photo'>";else{var r=n.value?n.value[0].toUpperCase():"<span class='webix_icon wxi-user'></span>";e+=h+"avatar_text'>"+r}return e+="</div></div>"},template:function(t,i){var e;if("$more"==t.id)e="<div class='webix_comments_more'>"+o.N.moreButton(t)+"</div>";else{t=S(t);var s=i.templateAvatar(t,i),n=i.templateUser(t,i),r=i.templateDate(t,i),h=i.templateMenu(t,i);t.text=i.templateMentioned(t),t.text=i.templateLinks(t),e=s+n+h+r+i.templateText(t,i)}return e},classname:function(t,i,e){var s=Kr.api.type.classname(t,i,e);return(t.user_id&&t.user_id==o.N.currentUser||!o.jA.count())&&(s+=" webix_comments_current"),s}};e=F.extend(e,i.listItem||{},!0);var s={$init:function(t){t.date&&(t.date=B.parseFormatDate(t.date))}};i.scheme&&Object.keys(i.scheme).forEach(function(t){s[t]=i.scheme[t]});var t={view:"list",navigation:!1,type:e,scheme:s,onClick:{webix_comments_menu:function(t,i){o.BA.isVisible()?o.BA.hide():(o.BA.setContext({obj:o,id:i}),o.BA.show(t.target,e.menuPosition||{pos:"left",y:30,x:10}))},webix_comments_more:function(){if(o.config.url&&o.callEvent("onDataRequest",[])){o.PA=!0;var t=o.TA.getItem("$more").value,i="chat"==o.N.mode?t:o.TA.getIndexById("$more"),e=U.$parse(o.config.url),s={error:function(){o.PA=!1}};"string"==typeof e&&(e=e+(e.indexOf("?")<0?"?":"&")+"pos="+i+"&more="+t),o.load(e,s,{pos:i,more:t})}}}};return i.save&&(t.save=i.save),t},IA:function(t){var i=this;t&&t.getItem?this.jA=t:(this.jA=new $r,this.Ht.push(this.jA),t&&"string"==typeof t?this.jA.load(t):this.jA.parse(t||[])),this.jA.data.attachEvent("onStoreUpdated",function(){return i.TA.refresh()})},zA:function(t){var s=this,i=this.config.readonly;i||this.XA(t),this.config.highlight&&(i||(this.qA=new RegExp("@((&quot;(.*?)&quot;)|([^\\s]{1,}))","g")),this.YA=new RegExp('@(("(.*?)")|([^\\s]{1,}))',"g")),b.all([this.TA.waitData,this.jA.waitData]).then(function(){s.TA.refresh()}),this.TA.data.attachEvent("onStoreUpdated",function(t,i,e){!t||"add"!==e&&"update"!==e||s.KA(i)})},XA:function(t){var i="object"!=M(t)?{}:t;"object"!==M(i.body)?i.body={data:this.jA}:i.body.data=this.jA,F.extend(i,{view:"mentionsuggest"},!0);var e=this.VA.define("suggest",i);this.VA.setValueHere=function(t,i,e){return-1!=t.indexOf(" ")&&(t='"'.concat(t,'"')),Cr.api.setValueHere.apply(this,[t,i,e])},this.HA=si(e)},KA:function(h){var o=this;if(-1!=h.text.indexOf("@")
){var a=this.HA&&this.HA.N.textValue||"value",u={};h.text.replace(this.YA,function(t,i,e,s){var n=s||i,r=o.jA.find(function(t){return t[a]==n},!0);return r&&!u[n]&&(o.callEvent("onUserMentioned",[r.id,h.id]),u[n]=!0),t})}}}),Co=(F.protoUI(ko,Ft,$n.view),{name:"timeline",defaults:{scroll:"auto"},$init:function(t){var s=this,i="x"===t.layout;if(i){var e=t.type;this.type.type=e&&e.type||"top",V(t.scroll)&&(t.scroll="x")}this.zt.className+=i?" webix_timeline_horizontal":" webix_timeline",this.$blockRender=!0,this.data.provideApi(this,!0),this.data.attachEvent("onStoreUpdated",function(t,i,e){return s.render(t,i,e)})},_id:"webix_tl_id",on_click:{},$setSize:function(t,i){this.$blockRender=!1,Ui.api.$setSize.call(this,t,i)&&this.refresh()},render:function(t,i,e){if(this.isVisible(this.N.id)&&!this.$blockRender){if("update"!=e)return this.callEvent("onBeforeRender",[this.data])&&(this.Oi=null,this.it.innerHTML=this.data.getRange().map(this.tt,this).join(""),this.callEvent("onAfterRender",[])),!0;var s=this.getItemNode(t);return ht(this.Oi[t]=this.Dc(i),s),rt(s),!0}},tt:function(t){this.callEvent("onItemRender",[t]);var i=this.getIndexById(t.id);return this.type.templateStart.call(this,t,this.type,i)+this.type.template.call(this,t,this.type,i)+this.type.templateEnd.call(this)},type:{type:"left",classname:function(t,i,e){var s="webix_timeline_item";return"alternate"!==i.type?s+="  webix_timeline_"+i.type:"x"==this.N.layout?s+=" webix_timeline_"+(e%2?"bottom":"top"):s+=" webix_timeline_"+(e%2?"right":"left"),i.css&&(s+=" "+i.css),t.$css&&("object"==M(t.$css)&&(t.$css=tt(t.$css)),s+=" "+t.$css),s},lineColor:function(t){return t.color},templateValue:Lt("#value#"),templateDetails:function(t){return t.details||""},templateDate:function(t){return en.dateToStr("%d %M, %Y")(t.date)},template:function(t,i,e){var s,n,r,h,o,a,u,c,f=te.dataPadding,l="string"==typeof i.lineColor?i.lineColor:i.lineColor(t,i),d="stroke-width:".concat(2,"px; stroke:").concat(l||te.timelineColor,";"),v=i.type,_=e+1==this.count(),p="position:relative;",b="",m="",g=i.templateDate(t,i),w=i.templateDetails(t,i),x='<div class="webix_timeline_value">'.concat(i.templateValue(t,i),"</div>\n\t\t\t\t").concat(w?'<div class="webix_timeline_details">'.concat(w,"</div>"):"");if("x"==this.N.layout){var y=this.$height-2*f,M=te.listItemHeight,S=f,k=y-M-14,C=M+14+f,$="top";"bottom"==v?(S=(M=y-M)+14+f,C=y-M+f+14,$="bottom"):"alternate"==v&&(S=(k=(M=Math.round(.5*y))-14)+f-20,C=M+14+f,e%2&&(S=C,$="bottom"));var D=t.$width||i.width;"auto"==D&&(D=this.JA([{text:x,css:"webix_timeline_event",height:k},{text:g,css:"webix_timeline_date"}]).width+f),b="top:".concat(S,"px;"),m="".concat($,":").concat(C,"px; height:auto; max-height:").concat(k,"px; width:inherit;"),s=D,n=M+14,p+="left:1px;",r=13,o="100%",c=a=h=M,u=7}else{var I=this.N.scroll?St.scrollSize:0,A=this.$width-2*f-I,T=Math.floor(.35*A),F=f,V=Math.floor(.65*A)-14,z=T+14+f,B=T-14;"right"==v?(F=(T=A-z+14+f)+14+f,z=f):"alternate"==v&&(z=(T=Math.floor(.5*A))+14+f,B=V=T-14,e%2&&(F=z,z=f));var H=t.$height||i.height;"auto"==H&&(H=this.JA([{text:x,css:"webix_timeline_event",width:V},{text:g,css:"webix_timeline_date",width:B}]).height+f),b="left:".concat(F,"px; width:").concat(B,"px;"),m="left:".concat(z,"px; width:").concat(V,"px; height:").concat(H-f,"px;"),s=T+14,n=H,p+="top:3px;",h=13,a="100%",u=o=r=T,c=7}return'<div style="'.concat(b,'" class="webix_timeline_date">').concat(g,'</div>\n\t\t\t\t\t<svg xmlns="http://www.w3.org/2000/svg" width="').concat(s,'px" height="').concat(n,'px" style="').concat(p,'">\n\t\t\t\t\t\t').concat(_?"":'<line x1="'.concat(r,'" y1="').concat(h,'" x2="').concat(o,'" y2="').concat(a,'" class="webix_timeline_node" style="').concat(d,'"/>'),'\n\t\t\t\t\t\t<circle cx="').concat(u,'" cy="').concat(c,'" r="').concat(6,'" class="webix_timeline_node webix_timeline_point" style="').concat(d,' fill:transparent;" />\n\t\t\t\t\t</svg>\n\t\t\t\t\t<div class="webix_timeline_event" style="').concat(m,'">\n\t\t\t\t\t\t').concat(x,"\n\t\t\t\t\t</div>")},widthSize:function(t,i){var e=t.$width||i.width;return e+(-1<e?"px":"")},
heightSize:function(t,i){var e=t.$height||i.height;return e+(-1<e?"px":"")},templateStart:function(t,i,e){return"x"==this.N.layout?"<div ".concat("webix_tl_id",'="',t.id,'" class="').concat(i.classname.call(this,t,i,e),'" style="width:').concat(i.widthSize(t,i),';">'):"<div ".concat("webix_tl_id",'="',t.id,'" class="').concat(i.classname.call(this,t,i,e),'" style="height:').concat(i.heightSize(t,i),';">')},templateEnd:Lt("</div>")},JA:function(t){var i=st("DIV");i.style.cssText="visibility:hidden;position:absolute;top:0px;left:0px;overflow:hidden;",document.body.appendChild(i);for(var e=0,s=0,n=0;n<t.length;n++){i.className="webix_measure_size "+t[n].css,i.style.width=t[n].width?t[n].width+"px":"auto",i.style.height=t[n].height?t[n].height+"px":"auto",i.innerHTML=t[n].text;var r=i.getBoundingClientRect();e=Math.max(e,Math.ceil(r.width)),s=Math.max(s,Math.ceil(r.height))}return rt(i),{width:e,height:s}},templateValue_setter:function(t){this.type.templateValue=Lt(t)},templateDetails_setter:function(t){this.type.templateDetails=Lt(t)},templateDate_setter:function(t){this.type.templateDate=Lt(t)},$skin:function(){this.type.height=te.timelineItemHeight,this.type.width=3*te.timelineItemHeight}}),$o=(F.protoUI(Co,Ke,Xe,ke,We,v,Ji,Ui.view),{name:"menu",Wm:"webix_menu",$init:function(t){t.autowidth&&(this.ZA=!0,delete t.autowidth),this.QA(),this.data.attachEvent("onStoreUpdated",k(function(){this.Au()},this)),this.attachEvent("onItemClick",function(t,i,e){var s=this.getItem(t);if(s){if(s.$template)return;var n=this.getTopMenu();if(!n.callEvent("onMenuItemClick",[t,i,e]))return void(i.showpopup=n.N.id);if(this!=n&&n.Cc(t,i,e),this.type.tT(s)||n.iT)(i.pointerType&&"mouse"!==i.pointerType||this===n&&"click"==n.N.openAction)&&this.Vu(t,e),i.showpopup=n.N.id;else n.Au(!0),n.eT&&n.hide()}}),this.attachEvent("onKeyPress",function(t){if(9===t)this.getTopMenu().Au();else if(13===t||32===t){var i,e=this.getSelectedId();e&&(i=this.getItemNode(e)),i&&dt(i,"MouseEvent","click")}}),this.data.attachEvent("onClearAll",function(){this.sT=[]}),this.data.sT=[],this.zt.setAttribute("role","menubar"),this.Ht=[]},QA:function(){this.attachEvent("onMouseMove",function(t,i,e){this.nT()&&this.Vu(t,e)}),this.attachEvent("onMouseOut",function(t){this.nT()&&"click"==this.N.openAction||this.rT||t.relatedTarget&&this.$view.contains(t.relatedTarget)||this.Au()})},sizeToContent:function(){if("y"==this.N.layout){var i=[],e=!1;this.data.each(function(t){i.push(this.tt(t)),t.submenu&&(e=!0)},this),this.config.width=pt(i,this.$view.className).width+16+2+(e?15:0),this.resize()}},getTopMenu:function(){for(var t=this;t.Iu;)t=si(t.Iu);return t},Gm:function(t){this.N.autoheight&&(t=this.count());for(var i=this.count(),e=0,s=0;s<t;s++){var n=this.data.pull[this.data.order[s]];n&&"Separator"==n.$template?(e+=4,this.N.autoheight||t++):e+=this.type.height}return this.Fc(t&&t<i,"y"),e},on_mouse_move:{},type:{tT:function(t){return t.submenu||t.data||t.item},css:"menu",width:"auto",aria:function(t,i,e){return'role="menuitem"'+(e&&e.webix_selected?' aria-selected="true" tabindex="0"':'tabindex="-1"')+(i.tT(t)?'aria-haspopup="true"':"")+(t.disabled?' aria-disabled="true"  webix_disabled="true"':"")},templateStart:function(t,i,e){if("Separator"===t.$template||"Spacer"===t.$template)return'<div webix_l_id="#id#" role="separator" tabindex="-1" class="webix_context_'+t.$template.toLowerCase()+'">';var s=(t.href?" href='"+t.href+"' ":"")+(t.target?" target='"+t.target+"' ":"");return Kr.api.type.templateStart(t,i,e).replace(/^<div/,"<a "+s)+(i.tT(t)&&i.subsign?"<div class='webix_submenu_icon'></div>":"")},templateEnd:function(t){return"Separator"===t.$template||"Spacer"===t.$template?"</div>":"</a>"},templateSeparator:Lt("<div class='sep_line'></div>"),templateSpacer:Lt("<div></div>")},getMenu:function(t){if(this.data.pull[t])return this;for(var i in this.data.pull){var e=this.getItem(i);if(e.submenu){var s=this.hT(e).getMenu(t);if(s)return s}}},getSubMenu:function(t){var i=this.getMenu(t),e=i.getItem(t);return e.submenu?i.hT(e):null},getMenuItem:function(t){return this.getMenu(t
).getItem(t)},hT:function(t){var i=si(t.submenu);return i||(t.submenu=this.oT(t),i=si(t.submenu)),i},nT:function(){var t=this.getTopMenu();if("click"!=t.N.openAction)return!0;var i=t.aT;return!(!i||!si(i).isVisible())},Vu:function(t,i){var e=this.getItem(t);if(e&&(this.rT=null,this.aT&&e.submenu!=this.aT&&this.Au(!0),this.type.tT(e)&&!this.config.hidden)){var s=this.hT(e);if(!this.isItemEnabled(t))return;s.show(i,{pos:this.N.subMenuPos}),s.Iu=this.N.id,this.aT=e.submenu}},disableItem:function(t){var i=this.getMenu(t);i&&i.Km(t,!0)},enableItem:function(t){var i=this.getMenu(t);i&&i.Km(t,!1)},isItemEnabled:function(t){var i=this.getMenu(t);if(i)return Kr.api.isItemEnabled.apply(i,arguments)},uT:function(t,i){var e=this.data;e.sT[t]!=i&&(e.sT[t]=i,e.filter(function(t){return!e.sT[t.id]}),this.resize())},hideItem:function(t){var i=this.getMenu(t);i&&i.uT(t,!0)},showItem:function(t){var i=this.getMenu(t);if(i)return i.uT(t,!1),Kr.api.showItem.call(i,t)},Au:function(t){if(this.aT){var i=si(this.aT);i.Au&&i.Au(t),!t&&i.Xn||(i.hide(),this.aT=null)}},oT:function(t){var i={view:"submenu",data:this.type.tT(t)},e=this.getTopMenu().N.submenuConfig;e&&F.extend(i,e,!0);var s=this.getMenuItem(t.id);s&&s.config&&F.extend(i,s.config,!0);var n=Qt(i);return this.Ht.push(n),n.Iu=this,n.N.id},Fu:function(t,i,e){var s=this.getItem(t);return"Separator"!=s.$template&&"Spacer"!=s.$template&&this.isItemEnabled(t)?t:(t=this.getNextId(t,e)||null)&&t!=i?this.Fu(t,i,e):i},$skin:function(){Kr.api.$skin.call(this),this.type.height=te.menuHeight},defaults:{scroll:"",layout:"x",mouseEventDelay:100,subMenuPos:"bottom"}}),Do={api:$o,view:F.protoUI($o,Kr.view)},Io={name:"submenu",$init:function(){this.Dt=l(this.cT),(this.Dt.Rt=this).attachEvent("onBeforeShow",function(){this.getTopMenu().ZA&&this.sizeToContent&&!this.isVisible()&&this.sizeToContent()}),this.it.setAttribute("role","menu")},$skin:function(){Do.api.$skin.call(this),er.api.$skin.call(this),this.type.height=te.menuHeight},QA:function(){this.attachEvent("onMouseMove",function(t,i,e){this.nT()&&this.Vu(t,e)}),this.attachEvent("onMouseOut",function(t){"click"!=this.getTopMenu().N.openAction&&(this.rT||this.Xn||!t.relatedTarget||this.$view.contains(t.relatedTarget)||this.hide())}),this.attachEvent("onMouseMoving",function(){this.Iu&&(si(this.Iu).rT=!0)})},cT:{$getSize:function(t,i){var e=1*this.Rt.N.height,s=1*this.Rt.N.width,n=Do.api.$getSize.call(this.Rt,t,i);return this.Rt.N.height=e,this.Rt.N.width=s,n},$setSize:function(t,i){this.Rt.N.scroll&&(this.Rt.Tn.style.height=i+"px")},destructor:function(){this.Rt=null}},body_setter:function(){},getChildViews:function(){return[]},defaults:{width:150,subMenuPos:"right",layout:"y",autoheight:!0},type:{height:te.menuHeight,subsign:!0}},Ao={api:Io,view:F.protoUI(Io,Do.view,er.view)},To={name:"sidemenu",defaults:{animate:!0,position:"left",width:200,borderless:!0},$init:function(){this.$view.className+=" webix_sidemenu"},$skin:function(){er.api.$skin.call(this),this.defaults.padding=0},position_setter:function(t){var i=this.N.position;return i&&_t(this.$view," webix_sidemenu_"+i),vt(this.$view," webix_sidemenu_"+t),t},$getSize:function(){var t=fe.api.$getSize.apply(this,arguments);return this.fT=t},$setSize:function(t,i){Gi.api.$setSize.call(this,t,i),t=this.xe-2*this.N.padding,i=this.Me-2*this.N.padding,this.qi.style.padding=this.N.padding+"px",this._n.style.display="none",this.Tn.style.height=i+"px",this.Dt.$setSize(t,i)},show:function(){if(!this.callEvent("onBeforeShow",arguments))return!1;this.N.hidden=!1,this.zt.style.zIndex=fi(this.N.zIndex),(this.N.modal||this.Vn)&&(this.pn(!0),this.Vn=null),this.zt.style.display="block",this.Ce(),this.N.position&&this.ei(),this.Rn=1,C(function(){this.Rn=0},this,[],St.fastClick?100:400),this.config.autofocus&&(this.En=Bi.getFocus(),Bi.setFocus(this)),-1==Jt.Ct.find(this)&&Jt.Ct.push(this),this.callEvent("onShow",[])},ei:function(t){var i,e,s,n,r,h=0,o=0,a={};this.$view.style.position="fixed",s=document.documentElement.offsetWidth,n=document.documentElement.offsetHeight,i=this.fT[0]||s,e=this.fT[2]||n,"top"==(
r=this.N.position)?i=s:"right"==r?(e=n,h=s-i):"bottom"==r?(i=s,o=n-e):e=n,a={left:h,top:o,width:i,height:e,maxWidth:s,maxHeight:n},"function"==typeof this.N.state&&this.N.state.call(this,a),this.lT=a,this.$setSize(a.width,a.height),void 0===t&&this.N.animate?(_t(this.$view,"webix_animate"),this._$[this.N.position].beforeShow.call(this,a),C(function(){vt(this.$view,"webix_animate",!0)},this,null,1),C(function(){this._$[this.N.position].show.call(this,a)},this,null,10)):("right"===this.N.position&&(a.left=a.right?s-a.width-a.right:s-a.width),this.setPosition(a.left,a.top))},lT:{},hidden_setter:function(t){return t?this.hide():this.show(),!!t},_$:{left:{beforeShow:function(t){this.$view.style.left=-t.width+"px",this.$view.style.top=t.top+"px"},show:function(t){this.$view.style.left=t.left?t.left+"px":"0px"},hide:function(t){this.$view.style.left=-t.width+"px"}},right:{beforeShow:function(t){this.$view.style.left="auto",this.$view.style.right=-t.width+"px",this.$view.style.top=t.top+"px"},show:function(t){this.$view.style.right=t.right?t.right+"px":"0px"},hide:function(t){this.$view.style.right=-t.width+"px"}},top:{beforeShow:function(t){this.setPosition(t.left,t.top),this.$view.style.height="0px",this.Tn.style.height="0px"},show:function(t){this.$view.style.height=t.height+"px",this.Tn.style.height=t.height+"px"},hide:function(){this.$view.style.height="0px",this.Tn.style.height="0px"}},bottom:{beforeShow:function(t){this.$view.style.left=t.left+"px",this.$view.style.top="auto";var i=t.bottom!=undefined?t.bottom:t.maxHeight-t.top-t.height;this.$view.style.bottom=i+"px",this.$view.style.height="0px"},show:function(t){this.$view.style.height=t.height+"px"},hide:function(){this.$view.style.height="0px"}}},Nn:function(){var t=document.documentElement.offsetWidth,i=document.documentElement.offsetHeight;if(this.N.animate&&t==this.lT.maxWidth&&i==this.lT.maxHeight){this._$[this.N.position].hide.call(this,this.lT);var e=Gt(this.$view,St.transitionEnd,k(function(){this.Ln(),Xt(e)},this))}else this.Ln()}},Fo=(F.protoUI(To,er.view),{name:"sidebar",defaults:{type:"sideBar",activeTitle:!0,select:!0,scroll:!1,collapsed:!1,collapsedWidth:44,position:"left",width:250,mouseEventDelay:10},$skin:function(){this.defaults.titleHeight=te.sidebarTitleHeight},$init:function(t){this.dT=V(t.width)?this.defaults.width:t.width,this.N.width=t.width=t.collapsed?t.collapsedWidth||this.defaults.collapsedWidth:this.dT,this.$view.className+=" webix_sidebar",this.$ready.push(this.vT),this.$ready.push(this._T),this.data.Lh=function(t){t.data?t.menu=S(t.data):t.item&&(t.menu=S(t.item.length?t.item:[t.item]))},t.multiselect=!1},on_context:{},on_mouse_move:{},vT:function(){this.attachEvent("onBeforeOpen",function(t){if(!this.config.multipleOpen)for(var i=this.getOpenItems(),e=0;e<i.length;e++)this.getParentId(t)==this.getParentId(i[e])&&this.close(i[e]);return!this.config.collapsed}),this.attachEvent("onItemClick",function(t,i,e){var s=this.getPopup();s&&!s.config.hidden&&(i.showpopup=s.config.id),i.pointerType&&"mouse"!==i.pointerType&&this.pT(t,e)}),this.attachEvent("onBeforeSelect",function(t){return!this.getItem(t).$count&&(this.clearCss("webix_sidebar_selected"),!0)}),this.attachEvent("onAfterSelect",function(t){this.bT(this,t,!te.sidebarMarkAll),this.getPopup().mT(t)}),this.attachEvent("onAfterUnSelect",function(){this.clearCss("webix_sidebar_selected")}),this.attachEvent("onMouseMove",function(t,i,e){this.pT(t,e)}),this.attachEvent("onMouseOut",function(){this.config.collapsed&&(this.getPopup().masterId=null)})},pT:function(t,i){if(this.config.collapsed){var e=this.getPopup();e&&(this.gT(t,e),this.wT(t,e),e.masterId=t,e.show(i,{x:"left"==this.config.position?this.config.collapsedWidth:-e.config.width,y:-1}))}},gT:function(t,i){var e=i.getBody().getChildViews()[0];e&&i.masterId!=t&&(e.parse(this.getItem(t)),this.getSelectedId()==t?vt(e.$view,"webix_selected",!0):_t(e.$view,"webix_selected"))},wT:function(t,i){var e=i.getBody().getChildViews()[1];if(e&&i.masterId!=t){this.exists(i.masterId)&&this.getItem(i.masterId).menu&&this.updateItem(i.masterId,{
menu:e.data.serialize()}),e.clearCss("webix_sidebar_selected"),e.unselectAll();var s=S(this.getItem(t).menu||[]);if(s.length){e.show(),e.data.importData(s);var n=this.getSelectedId();e.exists(n)?e.select(n):n&&this.bT(e,n)}else e.hide(),e.data.clearAll()}},_T:function(){var e,n=this,s=n.config;if(s.popup&&(e=si(s.popup)),!e){var t="left"==s.position?"webix_sidebar_popup_left":"webix_sidebar_popup_right",i="left"==s.position?"right":"left",r=function(t){var i="wxi-angle-"+("left"==s.position?"right":"left");return(t.submenu||t.data||t.item?'<div class="webix_icon '+i+'"></div>':"")+t.value},h=s.css?" "+s.css:"",o={view:"popup",css:"webix_sidebar_popup "+t+h,autofit:!1,width:this.dT-this.config.collapsedWidth,borderless:!0,padding:0,body:{rows:[{view:"template",borderless:!0,css:"webix_sidebar_popup_title",template:"#value#",height:this.config.titleHeight+2,onClick:{webix_template:function(){var t=this.getValues().id;n.getItem(t).$count||n.select(t)}}},{view:"menu",submenu:"data",layout:"y",subMenuPos:i,select:!0,borderless:!0,autoheight:!0,css:"webix_sidebar_popup_list "+t+h,template:r,type:{subsign:!1},submenuConfig:{padding:0,subMenuPos:i,template:r,select:!0,type:{subsign:!1},css:"webix_sidebar_popup_list "+t+h,on:{onShow:function(){this.clearCss("webix_sidebar_selected"),this.unselectAll();var t=n.getSelectedId();t&&this.exists(t)?this.select(t):t&&n.bT(this,t)},onBeforeSelect:function(t){if(this.getSubMenu(t))return!1},onAfterSelect:function(t){for(var i=n.getPopup().queryView({view:"menu"}),e=n.getParentId(t);e;){var s=i.getMenu(e);s&&(s.unselectAll(),n.bT(s,t)),e=n.getParentId(e)}n.bT(this,t)}}},on:{onBeforeSelect:function(t){if(this.getSubMenu(t))return!1},onMenuItemClick:function(t){this.getSubMenu(t)||n.select(t)}}}]}};F.extend(o,s.popup||{},!0),(e=Qt(o)).mT=function(t){if(n.config.collapsed&&1==n.getItem(t).$level){var i=e.getBody().getChildViews()[0];i&&vt(i.$view,"webix_selected",!0)}},e.queryView({view:"menu"}).iT=!0}e.attachEvent("onBeforeShow",function(){return s.collapsed}),this.Ht=[e],s.popupId=e.config.id,Yt(document.body,"pointermove",function(t){var i=t.target;e.config.hidden||e.$view.contains(i)||this.$view.firstChild.contains(i)||e.queryView({view:"menu"}).aT||this.$view.Tr&&this.$view.Tr.Lr||e.hide()},{bind:this})},bT:function(i,e,s){var n="webix_sidebar_selected";i.data.each(function(t){!this.xT(e,t.id)||s&&"0"!=this.getParentId(t.id)?i.hasCss(t.id,n)&&i.removeCss(t.id,n):i.addCss(t.id,n)},this)},xT:function(t,i){var e=this.getParentId(t);return i==e||!!e&&this.xT(e,i)},getPopup:function(){return si(this.config.popupId)},position_setter:function(t){var i=t,e="left"==t?"right":"left";_t(this.$view,"webix_sidebar_"+e),vt(this.$view,"webix_sidebar_"+i,!0);var s=this.getPopup();if(s){var n=s.$view;_t(n,"webix_sidebar_popup_"+e),vt(n,"webix_sidebar_popup_"+i,!0)}return t},select:function(t){t&&(I(t)&&(t=t.pop()),xo.api.select.call(this,t))},selectAll:function(){},collapse:function(){this.define("collapsed",!0)},expand:function(){this.define("collapsed",!1)},toggle:function(){var t=!this.config.collapsed;this.define("collapsed",t)},collapsed_setter:function(t){var i;return t?(i=this.config.collapsedWidth,this.closeAll(),this.type.collapsed=!0,_t(this.$view,"webix_sidebar_expanded")):(i=this.dT,this.type.collapsed=!1,vt(this.$view,"webix_sidebar_expanded",!0)),V(i)||i===this.config.width||(this.define("width",i),this.resize()),t},getState:function(){var t={collapsed:this.config.collapsed};return F.extend(t,bs.getState.call(this)),t},setState:function(t){bs.setState.call(this,t),this.define("collapsed",t.collapsed)}});Kt(xo.view,{name:"sideBar",height:"auto",template:function(t,i){return i.collapsed?i.icon(t,i):i.arrow(t,i)+i.icon(t,i)+"<span>"+t.value+"</span>"},arrow:function(t){for(var i="",e=1;e<=t.$level;e++){if(e==t.$level&&t.$count)i+="<span class='"+("webix_sidebar_dir_icon webix_icon "+("wxi-angle-"+(t.open?"down":"left")))+"'></span>"}return i},icon:function(t){var i="";return 2<t.$level&&(i='style="padding-left:'+40*(t.$level-2)+'px"'),
t.icon?"<span class='webix_icon webix_sidebar_icon "+t.icon+"' "+i+"></span>":"<span "+i+"></span>"}});F.protoUI(Fo,xo.view),F.protoUI({name:"context"},le,er.view);var Vo={name:"contextmenu",eT:!0,$init:function(t){t.submenuConfig&&F.extend(t,t.submenuConfig)}},zo=(F.protoUI(Vo,le,Ao.view),{name:"treetable",$init:function(){for(var t in F.extend(this.data,Ms,!0),F.extend(this.type,ks),F.extend(this,ws,!0),ms)this.on_click[t]||(this.on_click[t]=this.yT(ms[t]));this.type.treetable=Lt("{common.space()}{common.icon()} {common.folder()}"),this.type.treecheckbox=function(t){return t.indeterminate&&!t.nocheckbox?"<div class='webix_tree_checkbox webix_indeterminate'></div>":ks.checkbox.apply(this,arguments)},this.data.provideApi(this,!0),this.zt.setAttribute("role","treegrid")},ea:!1,yT:function(e){return function(t,i){return i=i.row,e.call(this,t,i)}},ta:function(t){for(var i=this.N.prerender?t.source:[t.start],e=0;e<i.length;e++)this.close(i[e])},getState:function(){var t=Ce.getState.call(this);return F.extend(t,bs.getState.call(this)),t},setState:function(t){bs.setState.call(this,t)&&Ce.setState.call(this,t)},clipboard_setter:function(t){return F.extend(this.Zn,Ss),ps.clipboard_setter.call(this,t)},fl:function(t,i){for(var e=t.start,s=0;s<e;s++){var n=this.data.order[s];n&&1!=this.getItem(n).$level&&t.start--}return Rh.api.fl.call(this,t,i)}}),Bo=(F.protoUI(zo,bs,ys,gs,Rh.view),{name:"filter",$init:function(t){t.mode=t.mode||"number",this.N.conditions=t.conditions,this.N.mode=this.mode_setter(t.mode),delete t.mode,t.rows=this.MT(t),this.$ready.push(this.AA)},$onLoad:function(t,i){return this.EA(t,i)},EA:function(t,i){var e=this,s=this.TA||this.queryView("list");s.data.driver=i;var n=[],r={};if("function"==typeof t.serialize?(t.data&&"DataStore"==t.data.name&&(t=t.data),t.each(function(t){return e.ST(t,n,r)})):i.getRecords(t).forEach(function(t){return e.ST(t,n,r)}),s.clearAll(),s.parse(n),this.TA){var h=this.N.value.includes;this.kT(),this.CT(h)}return!0},ST:function(t,i,e){var s=t[this.N.field];V(s)||e[s]||(e[s]=!0,i.push(S(t)))},AA:function(){var t=this;this.$T=!0,this.TA=this.queryView("list"),this.fv=this.queryView("toggle"),this.jo=this.queryView("richselect"),this.VA=this.queryView({batch:this.DT}),this.TA.data.provideApi(this,!0),this.TA.data.attachEvent("onSyncApply",function(){return t.EA(t.TA,t.TA.data.driver)}),this.setValue(this.N.value,"auto"),delete this.$T},mode_setter:function(t){if(this.IT[t],this.AT=this.TT(this.N.conditions,t),this.VA){var i=this.jo.getList();i.clearAll(),i.parse(this.AT),this.jo.config.value="",this.jo.setValue(this.AT[0].id,"auto")}else this.DT=this.AT[0].batch;return t},MT:function(t){var s=this,i=this.FT(t.inputs);return[{visibleBatch:this.DT,cols:[{view:"richselect",value:this.AT[0].id,width:160,options:this.AT,on:{onChange:function(t,i,e){s.VT(t),s.applyFilter(e)}}}].concat($(i))},{view:"toggle",batch:"includes",onLabel:B.combo.unselectAll,offLabel:B.combo.selectAll,value:!0,on:{onItemClick:function(){s.zT(s.fv.getValue()),s.callEvent("onChange",["user"])}}},{view:"list",batch:"includes",css:"webix_multilist",autoheight:!0,borderless:!0,yCount:5,type:"checklist",template:t.template||"#".concat(t.field,"#"),on:{onItemClick:function(t){var i=s.TA.getItem(t);s.TA.updateItem(t,{$checked:!i.$checked}),s.N.value.includes=s.BT(),s.HT(s.fv,s.Tw()),s.callEvent("onChange",["user"])}}}]},FT:function(t){var i=this;t=t||Object.keys(this.vi);for(var e=0;e<t.length;e++)if(this.vi[t[e]]){if(t[e]=S(this.vi[t[e]]),t[e].on){var s=t[e].on;for(var n in s)s[n]=function(){return i.applyFilter("user")}}}else t[e]&&t[e].batch;return t},vi:{text:{view:"text",batch:"text",on:{onTimedKeyPress:!0}},datepicker:{view:"datepicker",batch:"datepicker",on:{onChange:!0}},daterangepicker:{view:"daterangepicker",batch:"daterangepicker",on:{onChange:!0}},none:{view:"spacer",batch:"none"}},RT:{number:vn.number,text:vn.text,date:{greater:{batch:"datepicker",handler:vn.date.greater},less:{batch:"datepicker",handler:vn.date.less},greaterOrEqual:{batch:"datepicker",handler:vn.date.greaterOrEqual},lessOrEqual:{
batch:"datepicker",handler:vn.date.lessOrEqual},equal:{batch:"datepicker",handler:vn.date.equal},notEqual:{batch:"datepicker",handler:vn.date.notEqual},between:{batch:"daterangepicker",handler:vn.date.between},notBetween:{batch:"daterangepicker",handler:vn.date.notBetween}}},IT:{number:["greater","less","greaterOrEqual","lessOrEqual","equal","notEqual","contains","notContains"],text:["contains","notContains","equal","notEqual","beginsWith","notBeginsWith","endsWith","notEndsWith"],date:["greater","less","greaterOrEqual","lessOrEqual","equal","notEqual","between","notBetween"]},TT:function(t,i){t=t||this.IT[i];for(var e=[],s=0;s<t.length;s++){var n=this.ET(t[s],i);e.push(n)}return e},ET:function(t,i){if(t&&"function"==typeof t.handler)return t;if(this.RT[i][t]){var e={id:t,value:B.filter[t]},s="function"==typeof this.RT[i][t]?{batch:"text",handler:this.RT[i][t]}:this.RT[i][t];return F.extend(e,s,!0)}return null},PT:function(t){for(var i=0;i<this.AT.length;i++)if(this.AT[i].id==t)return this.AT[i]},BT:function(){var i=this,e=[];return this.TA.data.each(function(t){t.$checked&&e.push(t[i.N.field])}),e.length==this.TA.count()?null:e},getValue:function(){return{condition:{filter:this.VA.getValue?this.VA.getValue()||"":null,type:this.jo.getValue()},includes:this.BT()}},Tw:function(){for(var t=this.TA.data.order,i=0;i<t.length;i++)if(!this.getItem(t[i]).$checked)return!1;return!0},$compareValue:function(t,i){if(!t||t.condition.type!==i.condition.type||t.condition.filter!==i.condition.filter)return!1;if(t.includes&&i.includes){if(t.includes.length!==i.includes.length)return!1;for(var e={},s=0;s<t.includes.length;s++)e[t.includes[s]]=!0;for(var n=0;n<i.includes.length;n++)if(!e[i.includes[n]])return!1;return!0}return t.includes===i.includes},setValue:function(t,i){if(t=this.$prepareValue(t),!this.$compareValue(this.N.value,t)){var e=t.condition,s=t.includes;this.VT(e.type),this.HT(this.VA,e.filter),this.HT(this.jo,e.type),this.kT(),this.CT(s),this.HT(this.fv,this.Tw()),this.N.value=t,this.$T||this.callEvent("onChange",[i])}},CT:function(e){var s=this.N.field,n="date"==this.N.mode;e&&n&&(e=e.map(function(t){return t&&t.valueOf()})),this.TA.data.each(function(t){var i=t[s];t.$checked=!e||-1!=e.indexOf(n?i&&i.valueOf():i)}),this.TA.refresh()},HT:function(t,i){t.setValue&&(t.blockEvent(),t.setValue(i),t.unblockEvent())},$prepareValue:function(t){return(t=t||{}).condition=t.condition||{filter:"",type:this.AT[0].id},t.includes=t.includes||null,t},kT:function(){var i=this.VA.getValue?this.VA.getValue()||"":null;if(""===i)this.TA.filter();else{var e=this.N.field,s=this.PT(this.jo.getValue()).handler;this.TA.filter(function(t){return s(t[e],i)})}this.showBatch("includes",!!this.TA.count())},VT:function(t){var i=this.PT(t).batch;i!=this.DT&&(this.DT=i,this.VA=this.queryView({batch:i}),this.VA.setValue&&this.VA.setValue("","auto"),this.VA.getParentView().showBatch(i))},applyFilter:function(t){this.kT(),this.HT(this.fv,!0),this.zT(!0),this.callEvent("onChange",[t])},zT:function(i){this.TA.data.each(function(t){t.$checked=i}),this.TA.refresh(),this.N.value=this.getValue()},getFilterFunction:function(){var e=this.N.field,s="date"==this.N.mode,t=this.getValue(),n=t.includes,r=t.condition,h=this.PT(r.type).handler;return n&&s&&(n=n.map(function(t){return t&&t.valueOf()})),function(t){var i=t[e];return n?-1!=n.indexOf(s?i&&i.valueOf():i):""===r.filter||h(i,r.filter)}}}),Ho=(F.protoUI(Bo,Ft,$n.view),F.proto({name:"DataRecord",isVisible:function(){return!0},$init:function(t){this.data=t||{};var i=t&&t.id?t.id:z();this.N={id:i},Qt.views[i]=this},getValues:function(){return this.data},setValues:function(t,i,e){this.data=i?F.extend(this.data,t,!0):t,this.callEvent("onChange",[t,e])},refresh:function(){this.callEvent("onBindRequest")}},v,Li,Ft,Hi)),Ro=F.proto({name:"DataValue",isVisible:function(){return!0},$init:function(t){t&&!V(t.value)||(this.data=t||"");var i=t&&t.id?t.id:z();this.N={id:i},Qt.views[i]=this},setValue:function(t,i){this.data=t,this.callEvent("onChange",[t,i])},getValue:function(){return this.data},refresh:function(){this.callEvent(
"onBindRequest")}},v,Li),Eo=F.proto({name:"TreeCollection",$init:function(){F.extend(this.data,Ms,!0),this.data.provideApi(this,!0),F.extend(this,ws,!0)}},gs,$r);F.Date=en,F.Number=sn,F.promise=b,F.DataCollection=$r,F.DataRecord=Ho,F.DataValue=Ro,F.TreeCollection=Eo,F.AtomDataLoader=Ft,F.AtomRender=Ot,F.AutoScroll=Wt,F.AutoTooltip=Ji,F.BaseBind=Li,F.BindSource=Ni,F.Canvas=Zi,F.CodeParser=Vt,F.CollectionBind=Ei,F.ContextHelper=le,F.CopyPaste=_e,F.CustomPrint=pe,F.CustomScroll=be,F.DataMarks=me,F.DataMove=ge,F.DataLoader=ke,F.DataState=Ce,F.DataStore=Se,F.Destruction=Ri,F.DragControl=re,F.DragItem=$e,F.DragOrder=De,F.EditAbility=ze,F.EventSystem=v,F.FlexLayout=Be,F.Group=Ee,F.GroupMethods=He,F.GroupStore=Re,F.HTMLOptions=Pe,F.HtmlMap=je,F.IdSpace=Ne,F.KeysNavigation=Le,F.MapCollection=Oe,F.Modality=ae,F.MouseEvents=We,F.Movable=he,F.NavigationButtons=Ue,F.OverlayBox=qe,F.PagingAbility=Ye,F.ProgressBar=Ge,F.RecordBind=ji,F.RenderStack=Xe,F.ResizeArea=ue,F.SingleRender=Xi,F.Scrollable=Ke,F.SelectionModel=Je,F.Settings=Hi,F.Sparklines=_s,F.TablePaste=ps,F.TooltipControl=ni,F.Touch=ne,F.TreeAPI=bs,F.TreeClick=ms,F.TreeDataLoader=gs,F.TreeDataMove=ws,F.TreeRenderStack=xs,F.TreeStateCheckbox=ys,F.TreeStore=Ms,F.TreeTablePaste=Ss,F.TreeType=ks,F.UIManager=Bi,F.Undo=Ie,F.UploadDriver=Cs,F.ValidateCollection=$s,F.ValidateData=we,F.ValueBind=Pi,F.Values=Ds,F.VirtualRenderStack=Is,F.VRenderStack=As,F.html=yt,F.skin=se,F.debug=function Uo(t){if(t)if("object"!==M(t))h={events:!0};else for(var i in t)h[i]=t[i];else h={}},F.i18n=B,F.ready=li,F.env=St,F.color=Ze,F.csv=ve,F.clipbuffer=de,F.storage=hn,F.template=Lt,F.type=Kt,F.editors=Ve,F.animate=Qi,F.print=function(t,i){var e=si(t);if(e&&e.$printView&&(e=e.$printView()),e){var s;if(e.callEvent&&e.callEvent("onBeforePrint",[i]),function n(t){vt(document.body,"webix_print"),t.docHeader&&dn("Header",t),t.docFooter&&dn("Footer",t),it("@media print { @page{ size:"+t.paper+" "+t.mode+";margin-top:"+t.margin.top+"px;margin-bottom:"+t.margin.bottom+"px;margin-right:"+t.margin.right+"px;margin-left:"+t.margin.left+"px;}}","print")}(i=function r(t){(t=t||{}).paper=on[(t.paper||"").toLowerCase()]||"A4",t.mode=un[t.mode]?t.mode:"portrait",t.fit=an[t.fit]?t.fit:"page",t.scroll=t.scroll||!1,t.size=cn[t.paper],t.margin=t.margin||0===t.margin?t.margin:{};var i=isNaN(1*t.margin)?St.printMargin:t.margin;return t.margin={top:t.margin.top||0===t.margin.top?t.margin.top:i,bottom:t.margin.bottom||0===t.margin.bottom?t.margin.bottom:i,right:t.margin.right||0===t.margin.right?t.margin.right:i,left:t.margin.left||0===t.margin.left?t.margin.left:i},t}(i)),e.$customPrint){if(s=e.$customPrint(i)){if(s.then)return s.then(function(){return fn(i)});ln(e,i)}}else ln(e,i);fn(i)}},F.rules=mi,F.filters=vn,F.patterns=_n,F.fullscreen=zi,F.version="9.3.4",F.name="core",F.level_in=function qo(){0},F.level_out=function Yo(){0},F.clone=l,F.copy=S,F.single=function Go(t){var i=null;return function(){return i||(i=new t({})),i.jT&&i.jT.apply(i,arguments),i}},F.bind=k,F.exec=_,F.wrap=function Xo(i,e){return i?function(){var t=i.apply(this,arguments);return e.apply(this,arguments),t}:e},F.isUndefined=V,F.delay=C,F.once=o,F.uid=z,F.toNode=D,F.toFunctor=u,F.isArray=I,F.isDate=A,F.NT=T,F.LT=x,F.OT=qt,F.WT=Yt,F.event=Gt,F.eventRemove=Xt,F.callEvent=g,F.attachEvent=w,F.detachEvent=y,F.blockEvent=function(){return m.blockEvent()},F.unblockEvent=function(){return m.unblockEvent()},F.mapEvent=function(t){return m.mapEvent(t)},F.hasEvent=function(t){return m.hasEvent(t)},F.stringify=c,F.toPNG=function(s,n){var r=b.defer();return Dt(St.cdn+"/extras/html2canvas-1.0.min.js").then(function(){"string"==typeof n&&(n={filename:n}),(n=n||{}).export_mode="png";var t=si(s);if(t&&t.$exportView&&(t=t.$exportView(n)),!t)return r.reject(Ts);var i=t?t.$view:D(s),e=Hs(n.filename,"png");return window.html2canvas(i,{background:"#fff",logging:!1,useCORS:!0}).then(function(t){var i=function(t){!1!==n.download&&bt(t,e),r.resolve(t)};t.msToBlob?i(t.msToBlob()):t.toBlob(i,"image/png")}),r})},F.toCSV=function(t,i){i=i||{};var e=si(t);if(e&&e.$exportView&&(
e=e.$exportView(i)),!e)return b.reject(Ts);i.export_mode="csv",F.extend(i,{filterHTML:!0});var s=Bs(e,i),n=function o(t){return ve.stringify(t)}(Rs(e,i,s)),r=Hs(i.filename,"csv"),h=new Blob(["\ufeff"+n],{type:"text/csv"});return!1!==i.download&&bt(h,r),b.resolve(h)},F.toPDF=Ps,F.toExcel=Gs,F.alert=function Ko(){var t=Ii.apply(this,arguments);return t.type=t.type||"alert",ki(t)},F.confirm=Ai,F.modalbox=Ti,F.prompt=function Jo(){var t=Ii.apply(this,arguments);return t.type=t.type||"prompt",t.input=t.input||{},Di(t)},F.message=Fi,F.editStop=function Zo(){g("onEditEnd",[])},F.ajax=E,F.DataDriver=At,F.dp=ye,F.DataProcessor=Me,F.remote=gn,F.require=Dt,F.proxy=U,F.send=function Qo(t,i,e,s){var n=st("FORM",{target:s||"_self",action:t,method:e||"POST"},"");for(var r in i){var h=st("INPUT",{type:"hidden",name:r,value:i[r]},"");n.appendChild(h)}n.style.display="none",document.body.appendChild(n),n.submit(),document.body.removeChild(n)},F.ui=Qt,F.$$=si,Object.defineProperty(F,"UT",{value:!0})});
